...
import billingAdminReadiness from './routes/billing-admin-readiness';
...
import myTicketsRoutes from './routes/my-tickets';
...
import platformDemoRequestsRoutes from './routes/platform-demo-requests';
...
app.route('/', billingAdminReadiness);
...
app.route('/', platformDemoRequestsRoutes);
app.route('/', notificationsRoutes);
app.route('/', myTicketsRoutes);
