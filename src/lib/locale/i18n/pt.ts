...
export const pt: Dict = {
  ...
  invoices: {
    ...
    sentNoEmail: 'Não foi possível enviar o email.',
    confirmationResent: 'Confirmação de pagamento reenviada',
    confirmationSentOn: 'Confirmação de pagamento enviada',
    invoiceSentOn: 'Email da fatura enviado',
    resendNoRecipient: 'Esta fatura não tem email do cliente.',
    resendConfirmationBtn: 'Reenviar a confirmação de pagamento',
    downloadPdf: 'Transferir a fatura (PDF)',
    statusAwaitingTransfer: 'Transferência pendente',
  ...
  adminCenter: {
    ...
    evtSent: 'Proposta enviada',
    evtAccepted: 'Orçamento aceite pelo cliente',
    ...
    orgQuotesHeading: 'Todos os orçamentos da organização',
    platformHeading: 'Plataforma — todos os orçamentos (todas as organizações)',
    platformEmpty: 'Ainda não há orçamentos em nenhuma organização.',
    priceLabel: 'Preço',
    uidLabel: 'ID do utilizador',
    orgLabel: 'Organização',
    sourceLabel: 'Origem',
    currencyLabel: 'Moeda',
    stripeIdLabel: 'ID Stripe',
    quoteIdLabel: 'ID do orçamento',
    paidLabel: 'Pago',
    paymentPaid: 'Pago',
    paymentPending: 'Aguardando pagamento',
    paymentNone: 'Sem fatura',
  },
  myQuotes: {
    title: 'Os meus orçamentos',
    subtitle: 'Acompanhe as propostas que enviou — estado, preço e a atividade mais recente.',
    loading: 'A carregar…',
    ...
    quoteLabel: 'Orçamento',
    proposedBudget: 'Preço do orçamento',
    statusSent: 'Enviado',
  ...
  billingPage: {
    ...
    "pricingSection": {
      ...
      "subheadingPrefix": "Pagamento seguro com Stripe. Altere ou cancele o seu plano a qualquer momento.",
      "subheadingSuffix": "."
    },
    "currentPlan": {
      "label": "Plano atual",
  ...
  agentsPages: {
    "list": {
      ...
      "quoteBridgeTitle": "Pronto para os pôr a funcionar?",
      "quoteBridgeCta": "Obter um orçamento para isto",
      "quoteBridgeSeed": "Projeto de automação com IA baseado nos meus agentes recomendados: {agents}",
      "sections": {
    ...
    "recommendPanel": {
      ...
      "limitTitle": "Atingiu o seu limite mensal.",
      "limitBody": "Já utilizou todas as suas recomendações este mês.",
      "limitBodyCount": "Já utilizou as suas {used} de {limit} recomendações este mês.",
      "upgradeCta": "Atualizar o meu plano para continuar",
      "usageProgress": "{used} / {limit} recomendações utilizadas este mês"
    },
    "card": {
      "external": "Externo",
  ...
  dashboardHome: {
    ...
    "cta": {
      ...
      "demoModal": {
        ...
        "labelCountry": "País",
        "errorCountry": "Por favor selecione um país.",
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "result": {
        ...
        "costOfDelay": "Cada mês de espera representa um custo real em tempo e dinheiro perdidos.",
        "costOfDelayAmount": "Cada mês de espera custa-lhe cerca de {amount} em tempo e dinheiro perdidos.",
        "decisionHeading": "A sua decisão num relance",
        "decisionSummaryStrong": "Investe {invest} para recuperar {yearly}/ano — um retorno de {y1}× no primeiro ano.",
        "decisionSummaryLong": "Investe {invest} para recuperar {yearly}/ano — amortiza em ~{months} meses.",
        "decisionReturnLabel": "Retorno 1.º ano",
        "decisionThreeYearLabel": "Retorno em 3 anos",
      ...
      "send": {
        ...
        "intro": "Introduza o email do seu cliente — enviaremos a proposta com o preço do orçamento, pronta para aprovação online.",
        "emailLabel": "E-mail do cliente",
        "emailRequired": "O e-mail do cliente é obrigatório para enviar a proposta.",
        "budgetBelowMin": "O orçamento deve ser pelo menos {min} (o mínimo estimado).",
        "submit": "Enviar proposta ao cliente",
        "hint": "O seu cliente recebe a proposta e aprova o orçamento online.",
      ...
      "accepted": {
        "bankProceedCta": "Aprovar — receber as instruções de transferência",
        ...
        "s1": "Fatura gerada — disponível de imediato",
        "s2": "Pagamento seguro online ou por transferência",
        "s3": "Confirmação de pagamento por email",
        "s4": "A nossa equipa lança o seu projeto",
        "step1": "A sua fatura é gerada de imediato",
        "step2": "Pague online com cartão ou por transferência",
        "step3": "Recebe uma confirmação de pagamento por email",
        "step4": "A nossa equipa arranca com o seu projeto",
        ...
        "confirmTitle": "Aprove o seu orçamento",
        "confirmBody": "Um clique gera a sua fatura de imediato — acede ao pagamento seguro (cartão ou transferência) e a nossa equipa começa a preparar o seu projeto.",
        "confirmCta": "Aprovar e receber a minha fatura",
        "confirming": "A gerar a sua fatura…",
      ...
      "flow": {
        ...
        "s2": "A sua fatura é gerada de imediato",
        "s3": "Pague com cartão ou transferência",
        "s4": "O projeto começa"
      },
      "decision": {
        "priceLabel": "Investimento recomendado",
        "valueItem1": "Entrega de ponta a ponta — definição do âmbito, desenvolvimento, implementação e transferência incluídos",
        "valueItem2": "Uma equipa de especialistas dedicada, com acompanhamento em cada etapa",
        "valueItem3": "Âmbito validado em conjunto antes de qualquer faturação",
        "priceNote": "Sem pagamento hoje — a fatura só é emitida após a sua aprovação da proposta. Pagamento seguro por cartão ou transferência.",
        "impactHeading": "O que este projeto muda para o seu negócio",
        "impact1": "Horas de trabalho manual automatizadas todas as semanas — a sua equipa foca-se no valor",
        "impact2": "Menos erros manuais e uma conformidade pronta para auditoria",
        "impact3": "Capacidade de crescer sem aumentar a equipa",
        "suggestedLabel": "Preço sugerido (sistema)",
        "finalLabel": "Preço final enviado (USD)",
        "reasonPlaceholder": "Motivo do ajuste (opcional)",
        "resetPrice": "Repor",
        "billedUsd": "Faturado em USD. O cliente vê-o convertido na sua moeda.",
      ...
      "status": {
        ...
        "payNow": "Pagar agora",
        "paidThanks": "Pagamento recebido — obrigado! O seu email de confirmação está a caminho e a nossa equipa arranca com o seu projeto.",
        "payReady": "A sua fatura está pronta — pague com segurança agora.",
        ...
        "stateInvoice": "Fatura",
        "budgetLabel": "Valor do orçamento",
  ...
  contacts: {
    ...
    colSource: "Origem",
    colCountry: "País",
    colLeadStatus: "Estado do lead",
    colLastActivity: "Última atividade",
    colOwner: "Responsável",
    colLastMessage: "Último pedido",
    ...
    cancel: "Cancelar",
    save: "Guardar",
    modeCompanies: "Empresas",
    companyName: "Empresa",
    companyContacts: "Contactos",
    companyTwentyId: "ID de empresa Twenty",
    companyNoTwentyId: "não associada",
    companyUpdated: "Atualizada",
    companySearch: "Procurar empresa ou organização…",
    companyEmpty: "Ainda não há empresas.",
    companyCount: "empresas",
    companyDuplicate: "DUPLICADA",
    companyRename: "Mudar o nome",
    companyRenamePrompt: "Novo nome da empresa:",
    companyMerge: "Unir",
    companyMergeInto: "Unir à mantida",
    companyMergeKeeping: "A manter",
    companyMergePick: "escolha agora a duplicada a unir.",
    companyMergeConfirm: "Unir estas empresas? Todos os contactos passam para a empresa mantida. Não pode ser anulado.",
    companyReconcileDry: "Verificar consistência",
    companyReconcileApply: "Reparar agora",
    companyReconcileContacts: "Contactos analisados",
    companyReconcileRegistry: "Empresas no registo",
    companyReconcileUnlinked: "Contactos sem empresa associada",
    companyReconcileCreated: "Empresas a criar",
    companyReconcileDuplicates: "Empresas duplicadas",
    companyReconcileOrphans: "Empresas sem contactos",
    companyReconcileNoTwenty: "Empresas não associadas ao Twenty",
    companyReconcileWritten: "Registos escritos",
    companyTwentyCheck: "Verificar Twenty",
    companyTwentyRepair: "Reparar Twenty",
    companyTwentySyncConfirm: "Reparar o Twenty agora? Cada pessoa associada à empresa errada será reassociada à empresa guardada aqui. Isto escreve no Twenty.",
    companyTwentyPeople: "Pessoas no Twenty",
    companyTwentyChecked: "Verificadas",
    companyTwentySkipped: "Ignoradas (sem empresa associada)",
    companyTwentyMismatched: "Empresa errada no Twenty",
    companyTwentyCorrected: "Reparadas",
    companyTwentyCreated: "Empresas criadas no Twenty",
    companyTwentyFailures: "Falhas",
    modeSales: "Vendas",
    pipelineSection: "Funil",
    pipelineStage: "Fase",
    pipelinePriority: "Prioridade",
    pipelineNextFollowUp: "Próximo seguimento",
    pipelineLastContact: "Último contacto",
    pipelineNoNextStep: "Sem seguimento agendado",
    pipelineOverdue: "ATRASADO",
    pipelineLogActivity: "Registar atividade",
    pipelineChannel: "Canal",
    pipelineOutcome: "Resultado",
    pipelineNoOutcome: "Sem resultado",
    pipelineLog: "Registar",
    pipelineNotePlaceholder: "O que aconteceu? (opcional)",
    pipelineRemindIn: "Lembrar-me dentro de",
    pipelineTimeline: "Histórico",
    pipelineNoHistory: "Ainda nada registado.",
    pipelineNextSet: "Próximo seguimento a",
    pipelineBounced: "Endereço devolvido — nada agendado. Corrija primeiro o endereço.",
    stage_new: "Novo",
    stage_assigned: "Atribuído",
    stage_contacted: "Contactado",
    stage_attempted_contact: "Tentativa de contacto",
    stage_qualified: "Qualificado",
    stage_demo_scheduled: "Demo agendada",
    stage_demo_completed: "Demo realizada",
    stage_proposal_sent: "Proposta enviada",
    stage_negotiation: "Negociação",
    stage_won: "Ganho",
    stage_lost: "Perdido",
    stage_archived: "Arquivado",
    channel_email: "E-mail",
    channel_sms: "SMS",
    channel_call: "Chamada",
    channel_note: "Nota",
    priority_low: "Baixa",
    priority_normal: "Normal",
    priority_high: "Alta",
    priority_urgent: "Urgente",
    outcome_connected: "Contactado",
    outcome_no_answer: "Sem resposta",
    outcome_left_message: "Mensagem deixada",
    outcome_positive: "Positivo",
    outcome_negative: "Negativo",
    outcome_bounced: "Devolvido",
    event_created: "Criado",
    event_signup: "Registo",
    event_import: "Importação",
    event_demo_request: "Pedido de demo",
    event_assigned: "Atribuído",
    event_reassigned: "Reatribuído",
    event_unassigned: "Não atribuído",
    event_status_changed: "Fase",
    event_follow_up_scheduled: "Seguimento",
    event_email: "E-mail",
    event_sms: "SMS",
    event_call: "Chamada",
    event_note: "Nota",
    event_company_changed: "Empresa",
    event_twenty_synced: "Sinc. Twenty",
    salesQueue: "Fila de seguimento",
    salesQueueClear: "Nada atrasado. Cada lead tem um próximo passo.",
    salesRefresh: "Atualizar",
    salesLate: "de atraso",
    salesTotalLeads: "Leads totais",
    salesOpen: "Abertos",
    salesWon: "Ganhos",
    salesLost: "Perdidos",
    salesConversion: "Conversão",
    salesAvgCycle: "Ciclo médio",
    salesFollowUpRate: "Taxa de seguimento",
    salesOverdue: "Atrasados",
    salesDueToday: "Para hoje",
    salesNoNextStep: "Sem próximo passo",
    salesFunnel: "Funil",
    salesBySource: "Por origem",
    salesByOwner: "Por responsável",
    salesByCompany: "Por empresa",
    salesByOrg: "Por organização",
    salesConvHint: "total / conversão de leads decididos",
    salesScope: "Âmbito",
    salesScopeAll: "todos os leads",
    salesScopeAssigned: "leads atribuídos a si",
    unassigned: "Não atribuído",
    assignmentSection: "Atribuição",
    assignedTo: "Atribuído a",
    assignedBy: "Atribuído por",
    assignedAt: "Atribuído em",
    lastReassignedBy: "Última reatribuição por",
    lastReassignedAt: "Última reatribuição em",
    assignTo: "Atribuir a",
    assign: "Atribuir",
    transfer: "Transferir",
    importCsv: "Importar",
    importTitle: "Importar contactos",
    importHelp: "Escolha um ficheiro e a importação começa de imediato. Os duplicados são ignorados automaticamente.",
    importRowsFound: "linhas encontradas",
    importBatches: "lotes",
    importProgress: "A importar lote",
    importImported: "importados",
    importRejected: "linhas ignoradas",
    importStart: "Iniciar importação",
    importFormats: "Suportados: CSV (recomendado) e Excel .xlsx. No Google Sheets: Ficheiro → Transferir → Valores separados por vírgulas.",
    importColumns: "Colunas",
    importRequired: "Obrigatórias",
    importOptional: "Opcionais",
    importChooseFile: "Escolher ficheiro",
    importSample: "Transferir exemplo",
    importStageReading: "A ler o ficheiro…",
    importStageValidating: "A validar linhas…",
    importStageImporting: "A importar…",
    importStageDone: "Concluído",
    importFailed: "falharam",
    pageSize: "por página",
    loadMore: "Carregar mais",
    loadedCount: "carregados",
    scannedCount: "lidos",
    importErrors: {
      UNSUPPORTED_FORMAT: "Esse formato não é suportado. Guarde o ficheiro como .csv ou .xlsx.",
      NOT_A_ZIP: "Esse ficheiro não é um livro .xlsx legível.",
      NO_WORKSHEET: "Esse livro não tem nenhuma folha de cálculo.",
      UNSUPPORTED_COMPRESSION: "Esse livro usa uma compressão não suportada. Guarde-o novamente ou exporte como CSV.",
      CORRUPT_FILE: "Não foi possível ler esse ficheiro. Guarde-o novamente ou exporte como CSV.",
      EMPTY_FILE: "Esse ficheiro não tem linhas de dados.",
      NO_EMAIL_COLUMN: "Nenhuma coluna de e-mail encontrada. Adicione uma coluna «Email».",
      INVALID_EMAIL: "E-mail inválido",
      DUPLICATE_IN_FILE: "Duplicado no ficheiro",
      DUPLICATE_EXISTING: "Já está no CRM",
      MISSING_NAME: "Nome em falta",
      MISSING_COMPANY: "Empresa em falta",
      INVALID_PHONE: "Telefone inválido",
      INVALID_COUNTRY: "País inválido",
      WRITE_FAILED: "Não foi possível guardar",
    },
    sources: {
      manual: "Manual",
      quote: "Orçamento",
    ...
    errors: {
      ...
      FORBIDDEN: "Só pode gerir os contactos que lhe estão atribuídos.",
      FORBIDDEN_STATUS: "Só um proprietário ou administrador pode bloquear ou alterar o estado de um contacto.",
      FORBIDDEN_ASSIGN: "Apenas um super administrador pode atribuir um contacto a outro utilizador.",
      NOT_A_MEMBER: "Esse utilizador não é um membro ativo deste espaço de trabalho.",
      MEMBER_DISABLED: "Esse membro está desativado.",
      BATCH_TOO_LARGE: "Esse lote é demasiado grande. Divida o ficheiro.",
      DUPLICATE_COMPANY: "Outra empresa já usa esse nome. Una-as em vez disso.",
      INVALID_NAME: "É necessário um nome de empresa.",
      SAME_COMPANY: "Uma empresa não pode ser unida a si própria.",
      ALREADY_MERGED: "Essa empresa já foi unida.",
      CROSS_ORG_MERGE: "Empresas de organizações diferentes não podem ser unidas.",
      IMPORT_FAILED: "A importação parou. As linhas já importadas foram guardadas.",
   ...
   */
  enrichment: {
    title: 'Sistemas de IA observados em fontes públicas',
    subtitle: 'Provas públicas comparadas com o teu registo de IA para',
    loading: 'A carregar o instantâneo de provas…',
    loadError: 'Não foi possível carregar as provas deste relatório.',
    notFound: 'Este relatório não tem nenhum instantâneo de provas associado.',
    integrityFailed: 'Este instantâneo de provas já não corresponde à impressão digital registada e não pode ser apresentado.',
    disclaimer: 'As provas foram recolhidas de fontes de acesso público na data e hora indicadas. As conclusões descrevem o que foi observado e o que foi declarado; não são uma conclusão jurídica nem uma certificação.',
    snapshotId: 'Instantâneo',
    capturedAt: 'Capturado em',
    surface: 'Tipo de auditoria',
    ...
    coverageTitle: 'O que foi analisado',
    coverageNone: 'Não foi tentada qualquer fonte para este instantâneo.',
    sourcesRead: 'Fontes lidas com sucesso',
    coverageIncomplete: 'A cobertura ficou incompleta. As fontes indicadas acima não foram lidas, pelo que esta secção não é uma visão exaustiva da tua utilização de IA.',
    dropped: '{n} observação(ões) adicional(is) foram descartadas porque o instantâneo atingiu o limite de provas.',
    covRead: 'Lida',
    covPartial: 'Lida parcialmente',
    covRateLimited: 'Limite de pedidos',
    covUnavailable: 'Fonte indisponível',
    covBlocked: 'Bloqueada',
    covNotAnalyzed: 'Não analisada',
    observedTitle: 'Sistemas observados',
    observedNone: 'Não foi identificado qualquer sistema de IA nas fontes lidas.',
    isDeclared: 'declarado',
    notDeclared: 'não declarado',
    declaredTitle: 'Sistemas declarados (registo de IA)',
    declaredNone: 'O teu registo de IA não contém qualquer entrada ativa.',
    corroborated: 'corroborado',
    noPublicEvidence: 'sem provas públicas',
    cannotCompare: 'não comparável',
    findingsTitle: 'Conclusões',
    findingsNone: 'Não foi encontrada qualquer lacuna entre os sistemas observados em fontes públicas e os registados no teu registo de IA.',
    impactTotal: '{n} conclusão(ões). Impacto de conformidade aplicado à tua pontuação: {points} ponto(s).',
    capped: 'limitado',
    ...
    ruleId: 'Regra',
    subject: 'Sujeito',
    complianceImpact: 'Impacto de conformidade',
    impactNone: 'nenhum (apenas reportado)',
    evidenceTitle: 'Provas',
    evidenceAbsence: 'Esta conclusão baseia-se na ausência de uma observação, pelo que não cita qualquer prova capturada.',
    evidenceId: 'ID da prova',
    hash: 'Hash',
    comparisonTitle: 'Observado vs declarado',
    observedLabel: 'Observado',
    declaredLabel: 'Declarado',
    gapLabel: 'Lacuna',
    notObserved: 'não observado em fontes públicas',
    noRegistryEntry: 'sem entrada correspondente no registo de IA',
    gapUndeclared: 'Observado mas não declarado',
    gapUnverified: 'Declarado mas não observado',
    gapIncomplete: 'Entrada do registo não comparável',
  ...
  invoiceIdentity: {
    heading: 'Dados de faturação',
    subtitle: 'Quem emite as tuas faturas e como o imposto é aplicado.',
    ownerOnly: 'Apenas proprietários e administradores podem alterar os dados de faturação.',
    incomplete: 'Faltam dados obrigatórios. As faturas emitidas agora não estarão legalmente completas.',
    fLegalName: 'Denominação social',
    fAddress1: 'Morada',
    fAddress2: 'Morada (linha 2)',
    fPostalCode: 'Código postal',
    fCity: 'Cidade',
    fCountry: 'País (ISO-2)',
    fVatNumber: 'Número de IVA',
    fRegistration: 'Número de registo comercial',
    fTaxRate: 'Taxa de imposto (%)',
    fTaxLabel: 'Etiqueta do imposto',
    fCurrency: 'Moeda',
    fPaymentTerms: 'Prazo de pagamento (dias)',
    fFooter: 'Rodapé da fatura',
    snapshotNote: 'Cada fatura guarda uma cópia destes dados tal como estavam na emissão. As alterações aplicam-se apenas a faturas futuras.',
    vatMalformed: 'Guardado, mas o número de IVA não corresponde ao formato esperado para esse país.',
    save: 'Guardar',
    saved: 'Dados de faturação guardados.',
    saveError: 'Não foi possível guardar os dados de faturação.',
  },
