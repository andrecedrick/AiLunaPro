...
export const pt: Dict = {
  ...
  invoices: {
    ...
    sentNoEmail: 'Fatura confirmada, mas não foi possível enviar o email.',
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "accepted": {
        ...
        "confirmTitle": "Confirme o seu pedido",
        "confirmBody": "Confirme para aceitar esta proposta — vamos preparar a sua fatura e avisar a nossa equipa.",
        "confirmCta": "Confirmar aceitação",
