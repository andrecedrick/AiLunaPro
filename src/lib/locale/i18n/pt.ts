...
export const pt: Dict = {
  ...
  contacts: {
    ...
    importHelp: "Carregue um CSV com pelo menos uma coluna de e-mail. O nome e a empresa são obrigatórios em cada linha; telefone e país são opcionais. Os duplicados são ignorados.",
