...
export const en = {
  ...
  invoices: {
    ...
    nextNegotiation: 'Next: review the client budget, then set the final amount.',
  ...
  adminCenter: {
    ...
    superadminHeading: 'Superadmin visibility — all quotes',
    priceLabel: 'Price',
    uidLabel: 'User ID',
  ...
  myQuotes: {
    title: 'My quotes',
    subtitle: 'Track the proposals you sent — status, budget and the latest activity.',
    loading: 'Loading…',
    ...
    actAccepted: 'Client accepted the budget',
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "accepted": {
        "bankProceedCta": "Proceed with bank transfer",
        ...
        "confirmTitle": "Confirm the proposed budget",
        "confirmBody": "Confirm to accept the proposed budget — we'll prepare your invoice and notify our team.",
        "confirmCta": "Accept proposed budget",
  ...
  contacts: {
    ...
    errors: {
      ...
      FORBIDDEN: "You can only manage contacts you created.",
      FORBIDDEN_STATUS: "Only an owner or admin can block or change a contact's status.",
      INVALID_INPUT: "Please check the contact details (a valid name and email are required).",
