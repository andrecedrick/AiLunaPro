...
export const en = {
  ...
  contacts: {
    ...
    importHelp: "Upload a CSV with at least an email column. Name and company are required on every row; phone and country are optional. Duplicates are skipped.",
