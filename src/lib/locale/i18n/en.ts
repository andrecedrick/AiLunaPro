...
export const en = {
   ...
   */
  enrichment: {
    title: 'AI systems observed in public sources',
    subtitle: 'Public evidence compared against your AI registry for',
    loading: 'Loading the evidence snapshot…',
    loadError: 'The evidence for this report could not be loaded.',
    notFound: 'No evidence snapshot is attached to this report.',
    integrityFailed: 'This evidence snapshot no longer matches its recorded fingerprint and cannot be displayed.',
    disclaimer: 'Evidence was collected from publicly accessible sources at the timestamp shown. Findings describe what was observed and what was declared; they are not a legal conclusion and not a certification.',
    snapshotId: 'Snapshot',
    ...
    engine: 'Engine',
    rulesets: 'Rulesets',
    coverageTitle: 'What was analyzed',
    coverageNone: 'No source was attempted for this snapshot.',
    sourcesRead: 'Sources read successfully',
    coverageIncomplete: 'Coverage was incomplete. The sources listed above were not read, so this section is not an exhaustive view of your AI usage.',
    dropped: '{n} additional observation(s) were discarded because the snapshot reached its evidence limit.',
    covRead: 'Read',
    covPartial: 'Partially read',
    covRateLimited: 'Rate limited',
    covUnavailable: 'Source unavailable',
    covBlocked: 'Blocked',
    covNotAnalyzed: 'Not analyzed',
    observedTitle: 'Observed systems',
    observedNone: 'No AI system was identified in the sources that were read.',
    isDeclared: 'declared',
    notDeclared: 'not declared',
    declaredTitle: 'Declared systems (AI registry)',
    declaredNone: 'Your AI registry contains no active entry.',
    corroborated: 'corroborated',
    noPublicEvidence: 'no public evidence',
    cannotCompare: 'cannot be compared',
    findingsTitle: 'Findings',
    findingsNone: 'No gap was found between the systems observed in public sources and the systems recorded in your AI registry.',
    impactTotal: '{n} finding(s). Compliance impact applied to your score: {points} point(s).',
    capped: 'capped',
    ...
    impactNone: 'none (reported only)',
    evidenceTitle: 'Evidence',
    evidenceAbsence: 'This finding is based on the absence of an observation, so it cites no captured evidence.',
    evidenceId: 'Evidence ID',
    hash: 'Hash',
    comparisonTitle: 'Observed vs declared',
    observedLabel: 'Observed',
    declaredLabel: 'Declared',
    gapLabel: 'Gap',
    notObserved: 'not observed in public sources',
    noRegistryEntry: 'no matching entry in the AI registry',
    gapUndeclared: 'Observed but not declared',
    gapUnverified: 'Declared but not observed',
    gapIncomplete: 'Registry entry cannot be compared',
