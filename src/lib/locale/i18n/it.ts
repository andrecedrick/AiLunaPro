...
export const it: Dict = {
  ...
  bankSettings: {
    heading: 'Coordinate bancarie',
    subtitle: 'Mostrate sulle fatture come opzione di pagamento.',
    countryLabel: 'Codice paese',
    countryPlaceholder: 'es. IT',
    regionLabel: 'Regione bancaria',
    regionEu: 'Europa (IBAN)',
    regionUs: 'Stati Uniti',
    regionGlobal: 'Asia / Globale',
    fAccountName: 'Nome del conto',
    fAccountNumber: 'Numero di conto',
    fRoutingNumber: 'Numero di routing',
    fBankName: 'Nome della banca',
    fAccountHolder: 'Intestatario del conto',
    save: 'Salva coordinate',
    saved: 'Coordinate salvate',
    saveError: 'Salvataggio non riuscito. Riprova.',
    validationError: 'Controlla questo valore.',
    ownerOnly: 'Solo i proprietari e gli amministratori possono modificare le coordinate bancarie.',
  },
  invoices: {
    title: 'Fatture',
    subtitle: 'Fatture create quando un cliente accetta un preventivo.',
    loading: 'Caricamento…',
    error: 'Impossibile caricare le tue fatture. Riprova.',
    ...
    sentNoEmail: 'Non è stato possibile inviare l’email.',
    confirmationResent: 'Conferma di pagamento reinviata',
    confirmationSentOn: 'Conferma di pagamento inviata',
    invoiceSentOn: 'Email della fattura inviata',
    resendNoRecipient: 'Questa fattura non ha l’email del cliente.',
    resendConfirmationBtn: 'Reinvia la conferma di pagamento',
    downloadPdf: 'Scarica la fattura (PDF)',
    ...
    queueEmpty: 'Nessun preventivo in attesa di prezzo al momento.',
    queueSubtitle: 'Un cliente ha risposto: imposta l’importo finale per creare la fattura.',
    stageAcceptedLabel: 'Accettato',
    stageNegotiationLabel: 'Negoziazione',
    nextAccepted: 'Avanti: imposta l’importo finale per creare e inviare la fattura.',
    clientMessageLabel: 'Messaggio del cliente',
  ...
  adminCenter: {
    nav: 'Centro Amministrazione',
    title: 'Centro Amministrazione',
    subtitle: 'Monitora preventivi, fatture e attività dei clienti della tua organizzazione in un unico posto.',
    restricted: 'Il Centro Amministrazione è riservato ai super amministratori.',
    activityHeading: 'Attività recente',
    activityEmpty: 'Ancora nessuna attività.',
    evtSent: 'Proposta inviata',
    evtAccepted: 'Preventivo accettato dal cliente',
    evtInvoiceSent: 'Fattura inviata',
    evtPaid: 'Pagamento ricevuto',
    statusWaitingResponse: 'In attesa della tua risposta',
    replyHint: 'rispondi all’email di notifica per replicare',
    allQuotesHeading: 'Tutti i preventivi — ciclo di vita completo',
    allQuotesEmpty: 'Ancora nessun preventivo inviato.',
    tlCreated: 'Creato',
    tlSent: 'Inviato',
    tlAccepted: 'Accettato',
    tlChanges: 'Modifiche richieste',
    tlInvoiced: 'Fatturato',
    blocked: 'Bloccato',
    suspended: 'Sospeso',
    save: 'Salva',
    block: 'Blocca',
    ...
    genPaymentLink: 'Genera link di pagamento',
    orgQuotesHeading: 'Tutti i preventivi dell’organizzazione',
    platformHeading: 'Piattaforma — tutti i preventivi (tutte le organizzazioni)',
    platformEmpty: 'Ancora nessun preventivo in alcuna organizzazione.',
    priceLabel: 'Prezzo',
    uidLabel: 'ID utente',
    ...
    quoteIdLabel: 'ID preventivo',
    paidLabel: 'Pagato',
    paymentPaid: 'Pagato',
    paymentPending: 'In attesa di pagamento',
    paymentNone: 'Nessuna fattura',
    discussionsHeading: 'Conversazioni con i clienti',
    discussionsEmpty: 'Ancora nessun messaggio dai clienti.',
    contextLabel: 'Contesto',
  },
  myQuotes: {
    title: 'I miei preventivi',
    subtitle: 'Tieni traccia delle proposte che hai inviato — stato, prezzo e l’ultima attività.',
    loading: 'Caricamento…',
    error: 'Impossibile caricare i tuoi preventivi. Riprova.',
    empty: 'Non hai ancora inviato alcun preventivo.',
    createCta: 'Crea un preventivo',
    quoteLabel: 'Preventivo',
    proposedBudget: 'Prezzo del preventivo',
    statusSent: 'Inviato',
    statusReviewing: 'In esame',
    statusNegotiation: 'Negoziazione',
    statusValidated: 'Convalidato',
    statusInvoiced: 'Fatturato',
    statusBlocked: 'Bloccato',
    statusSuspended: 'Sospeso',
    changesRequested: 'Il cliente ha richiesto modifiche',
    negotiationNextStep: "Imposta l'importo finale nel Centro Amministrazione per rispondere.",
    waitingResponse: 'In attesa della risposta del cliente',
    lastActivity: 'Ultima attività',
    actCreated: 'Preventivo creato',
    actSent: 'Proposta inviata al cliente',
    actAccepted: 'Il cliente ha accettato il preventivo',
    actChangesRequested: 'Il cliente ha richiesto modifiche',
    actInvoiced: 'Fattura creata',
  },
  shell: {
  ...
  auth: {
    ...
    "error": { "companyRequired": "L’azienda è obbligatoria." },
    "field": {
  ...
  billingPage: {
    ...
    "pricingSection": {
      ...
      "subheadingPrefix": "Pagamento sicuro con Stripe. Cambia o annulla il tuo piano in qualsiasi momento.",
      "subheadingSuffix": "."
    },
    "currentPlan": {
      "label": "Piano attuale",
  ...
  tokensPage: {
    ...
    "packs": {
      "sectionTitle": "Sblocca più analisi",
      ...
      "tokensUnit": "token",
      "amountPrefix": "+{amount}",
      "buyPack": "Sblocca il mio piano completo",
      "redirecting": "Reindirizzamento…",
      "readOnlyButton": "Sola lettura"
    },
    "planUsage": {
      "title": "Utilizzo del piano",
      "included": "{limit} audit/mese inclusi nel tuo piano",
      "thisMonth": "{used} / {limit} audit questo mese",
      "unlimited": "Audit illimitati",
      "limitFree": "Hai utilizzato tutti i {limit} audit inclusi. Passa a un piano superiore per continuare a fare audit.",
      "limitPaid": "Hai utilizzato {used}/{limit} audit — gli audit aggiuntivi ora utilizzano i token.",
      "upgradeCta": "Cambia piano"
    },
    "usage": {
  ...
  orgCreate: {
    ...
    "planDesc": {
      ...
      "starter": "15 audit, 5 postazioni",
      "professional": "30 audit, 20 postazioni",
  ...
  agentsPages: {
    "list": {
      ...
      "quoteBridgeTitle": "Pronto a metterli all'opera?",
      "quoteBridgeCta": "Richiedi un preventivo per questo",
      "quoteBridgeSeed": "Progetto di automazione IA basato sui miei agenti consigliati: {agents}",
      "sections": {
    ...
    "recommendPanel": {
      ...
      "limitTitle": "Hai raggiunto il tuo limite mensile.",
      "limitBody": "Hai utilizzato tutti i tuoi suggerimenti questo mese.",
      "limitBodyCount": "Hai utilizzato tutti i tuoi {used} suggerimenti su {limit} questo mese.",
      "upgradeCta": "Aggiorna il tuo piano per continuare",
      "usageProgress": "{used} / {limit} suggerimenti utilizzati questo mese"
    },
    "card": {
      "external": "Esterno",
  ...
  dashboardHome: {
    ...
    "cta": {
      ...
      "demoModal": {
        ...
        "labelCountry": "Paese",
        "errorCountry": "Seleziona un paese.",
        "placeholderPhone": "Numero di telefono",
        "errorPhone": "È richiesto un numero di telefono valido.",
  ...
  feedback: {
    ...
    "sat4": "Buona",
    "sat5": "Eccellente",
    "difficultyLabel": "È stato facile da usare?",
    "diffEasy": "Facile",
    "diffOk": "Discreto",
    "diffHard": "Difficile",
    "blockerLabel": "Cosa ti ha impedito di andare avanti?",
    "blockerPlaceholder": "Facoltativo — dicci cosa ti ha bloccato",
    "suggestionLabel": "Possiamo migliorare qualcosa?",
    "suggestionPlaceholder": "Facoltativo",
    "submit": "Invia",
    "success": "Grazie — leggiamo ogni commento.",
    "dismissAria": "Chiudi il feedback"
  },
  publicTools: {
    "diagnostic": {
      "header": {
    ...
    "quote": {
      "header": {
        ...
        "subtitle": "Ottieni subito una fascia di prezzo indicativa per un progetto personalizzato di agente AI, automazione o sito web.",
        "freeLine": "Stima gratuita · Nessun account richiesto · Solo a titolo indicativo"
      },
      "resumeNotice": "Bentornato — abbiamo ripristinato le tue selezioni precedenti.",
      "form": {
        "serviceLegend": "Di cosa hai bisogno?",
        "serviceLabel": "Tipo di servizio",
        "servicePlaceholder": "Seleziona un servizio…",
        "tierLabel": "Complessità del progetto",
        "tierPlaceholder": "Seleziona un livello di complessità…",
        "descriptionLabel": "Descrizione del progetto",
        "descriptionPlaceholder": "Descrivi brevemente il tuo progetto, gli obiettivi e gli strumenti da integrare. Non includere dati riservati o personali.",
        "optionalLegend": "Qualche dettaglio in più (facoltativo)",
        "businessSizeLabel": "Dimensione dell'azienda",
        "urgencyLabel": "Urgenza",
        "budgetBandLabel": "Fascia di budget",
        "notSpecified": "Non specificato"
      },
      "services": {
        "ai_agent": "Agente AI",
        "automation": "Flusso di lavoro di automazione",
        "website": "Sito web / web app",
        "audit": "Audit di fattibilità"
      },
      "tiers": {
        "simple": "Semplice",
        "contextual": "Contestuale (MVP)",
        "autonomous": "Autonomo",
        "multi_agent": "Sistema multi-agente",
        "intermediate": "Intermedio",
        "complex": "Complesso",
        "custom": "Personalizzato / su misura",
      ...
      "budgetBands": {
        ...
        "10k_50k": "$10k–$50k",
        "50k_150k": "$50k–$150k",
        "over_150k": "Oltre $150k"
      },
      "requiredMark": "*",
      "submit": {
        "idle": "Ottieni la mia stima"
      },
      "errors": {
        "service": "Scegli un tipo di servizio.",
        "tier": "Scegli un livello di complessità.",
        "description": "Descrivi il tuo progetto (almeno 20 caratteri)."
      },
      "result": {
        ...
        "costOfDelayAmount": "Ogni mese di attesa ti costa circa {amount} in tempo e denaro persi.",
        "decisionHeading": "La tua decisione in sintesi",
        "decisionSummaryStrong": "Investi {invest} per recuperare {yearly}/anno — un ritorno di {y1}× nel primo anno.",
        "decisionSummaryLong": "Investi {invest} per recuperare {yearly}/anno — si ripaga in ~{months} mesi.",
        "decisionReturnLabel": "Ritorno 1° anno",
        "decisionThreeYearLabel": "Ritorno su 3 anni",
        "decisionBreakevenLabel": "Rientro",
        "decisionMultiple": "{mult}×",
        "decisionMonths": "~{months} mesi",
        "ctaStartRecovering": "Inizia a recuperare {amount}/mese",
        ...
        "disclaimer": "Stima indicativa e non contrattuale, fornita solo a scopo di budget — a titolo puramente informativo. Il prezzo finale dipende da uno scope dettagliato.",
        "ctaHeading": "Pronto a procedere?",
        "ctaBody": "Crea un workspace AiLunaPro gratuito per generare un preventivo PDF brandizzato e avviare il tuo progetto.",
        "ctaButton": "Crea il tuo account gratuito ↗",
        "rerunButton": "Ricomincia"
      },
      "solutions": {
        "ai_agent.simple": "Agente AI semplice",
        "ai_agent.contextual": "Agente AI contestuale (MVP)",
        "ai_agent.autonomous": "Agente AI autonomo",
        "ai_agent.multi_agent": "Sistema multi-agente",
        "automation.simple": "Flusso di lavoro di automazione semplice",
        "automation.contextual": "Flusso di lavoro di automazione contestuale",
        "automation.autonomous": "Sistema di automazione autonomo",
        "automation.multi_agent": "Piattaforma di automazione multi-agente",
        "website.simple": "Sito web semplice",
        "website.intermediate": "Sito web intermedio",
        "website.complex": "Piattaforma web complessa",
        "website.custom": "Piattaforma personalizzata / su misura",
        "audit.feasibility": "Studio di fattibilità e definizione dello scope"
      },
      "scope": {
        "discovery": "Workshop di discovery e requisiti",
        "design": "Progettazione della soluzione e architettura",
        "integration": "Integrazione con i tuoi strumenti (CRM/ERP, API)",
        "deployment": "Deployment e consegna",
        "monitoring": "Configurazione di monitoraggio e supporto",
        "mapping": "Mappatura dei processi e progettazione del flusso di lavoro",
        "build": "Realizzazione e sviluppo",
        "content": "Configurazione di contenuti e dati",
        "launch": "Lancio e go-live",
        "assessment": "Valutazione dello stato attuale",
        "gapAnalysis": "Analisi dei gap",
        "recommendations": "Raccomandazioni prioritizzate",
        "roadmap": "Roadmap di implementazione"
      },
      "nextSteps": {
      ...
      "generate": {
        "button": "Ricevi il mio piano personalizzato",
        "cost": "{n} token",
        "loading": "Generazione…",
      ...
      "send": {
        "heading": "Invia la proposta al tuo cliente",
        "intro": "Inserisci l'email del tuo cliente: gli invieremo la proposta con il prezzo del preventivo, pronta per l'approvazione online.",
        "emailLabel": "Email del cliente",
        "emailRequired": "L'email del cliente è obbligatoria per inviare la proposta.",
        "budgetBelowMin": "Il budget deve essere almeno {min} (il minimo stimato).",
        "submit": "Invia la proposta al cliente",
        "hint": "Il tuo cliente riceve la proposta e approva il preventivo online.",
        "sentTo": "Proposta inviata a {email}",
        "sentNext": "Ti avviseremo quando il tuo cliente risponde. Tieni traccia nel Centro Amministrazione.",
        "track": "Apri il Centro Amministrazione"
      },
      "override": {
      ...
      "accepted": {
        "bankProceedCta": "Approva — ricevi le istruzioni per il bonifico",
        "bankMessage": "Per progetti superiori a 15.000 $, il pagamento è protetto tramite bonifico bancario.",
        "title": "La tua risposta è stata inviata",
        "s1": "Fattura generata: disponibile subito",
        "s2": "Pagamento sicuro online o con bonifico",
        "s3": "Conferma di pagamento via email",
        "s4": "Il nostro team avvia il tuo progetto",
        "step1": "La tua fattura viene generata all'istante",
        "step2": "Paga online con carta o con bonifico",
        "step3": "Ricevi una conferma di pagamento via email",
        "step4": "Il nostro team avvia il tuo progetto",
        ...
        "confirmTitle": "Approva il tuo preventivo",
        "confirmBody": "Un clic genera subito la tua fattura: accedi al pagamento sicuro (carta o bonifico) e il nostro team inizia a preparare il tuo progetto.",
        "confirmCta": "Approva e ricevi la fattura",
        "confirming": "Generazione della fattura…",
        "confirmError": "Si è verificato un problema. Riprova o rispondi all'email della tua proposta.",
        "discussConfirmBody": "Conferma per inviare la tua richiesta di modifica al nostro team.",
        "discussCta": "Invia richiesta",
        "sentTitle": "Richiesta ricevuta",
        "sentBody": "Abbiamo ricevuto la tua richiesta e ti contatteremo per adeguare la proposta.",
      ...
      "flow": {
        ...
        "s2": "La tua fattura viene generata all'istante",
        "s3": "Paga con carta o bonifico",
        "s4": "Il progetto parte"
      },
      "decision": {
        "priceLabel": "Investimento consigliato",
        "valueItem1": "Consegna end-to-end: analisi, sviluppo, deployment e passaggio di consegne inclusi",
        "valueItem2": "Un team di esperti dedicato, con supporto in ogni fase",
        "valueItem3": "Perimetro validato insieme prima di qualsiasi fatturazione",
        "priceNote": "Nessun pagamento oggi: la fattura viene emessa solo dopo la tua approvazione della proposta. Pagamento sicuro con carta o bonifico.",
        "impactHeading": "Cosa cambia questo progetto per la tua azienda",
        "impact1": "Ore di lavoro manuale automatizzate ogni settimana: il tuo team si concentra sul valore",
        "impact2": "Meno errori manuali e una conformità pronta per gli audit",
        "impact3": "La capacità di crescere senza aumentare l'organico",
        "suggestedLabel": "Prezzo suggerito (sistema)",
        "finalLabel": "Prezzo finale inviato (USD)",
        "reasonPlaceholder": "Motivo della modifica (facoltativo)",
        "resetPrice": "Reimposta",
        "billedUsd": "Fatturato in USD. Il cliente lo vede convertito nella sua valuta.",
        ...
        "budgetRequired": "Inserisci il tuo budget prima di inviare.",
        ...
        "submitHint": "Il tuo cliente convaliderà questo importo o richiederà un adeguamento.",
        "accept": "Invia il mio budget",
      ...
      "status": {
        ...
        "payNow": "Paga ora",
        "paidThanks": "Pagamento ricevuto, grazie! La tua email di conferma è in arrivo e il nostro team avvia il tuo progetto.",
        "payReady": "La tua fattura è pronta: paga in modo sicuro ora.",
        "budgetLabel": "Importo del preventivo",
        "waitingValidation": "In attesa di convalida",
        "bank": {
          "heading": "Istruzioni per il bonifico bancario",
          "secureNote": "Completa il pagamento tramite bonifico bancario sicuro utilizzando i dati seguenti.",
          "cardHint": "Pagamento sicuro tramite bonifico bancario",
          "amountLabel": "Importo",
          "referenceLabel": "Causale di pagamento",
          "companyLabel": "Azienda",
          "bankLabel": "Banca",
          "ibanLabel": "IBAN",
          "swiftLabel": "SWIFT / BIC",
          "deadlineLabel": "Da pagare entro il",
          "initiateBtn": "Ho effettuato il bonifico",
          "awaitingConfirm": "Grazie — confermeremo non appena riceviamo il bonifico.",
          "invoiceNote": "La fattura viene emessa una volta ricevuto il pagamento."
        },
  ...
  auditTools: {
    nav: {
      worksheetLabel: "Audit Tempo → Denaro",
      worksheetHint: "Usa i tuoi dati reali, attività per attività",
      visibilityLabel: "Visibilità IA e Social",
      visibilityHint: "Presenza in ChatGPT/Perplexity + audit social",
    },
    worksheet: {
      title: "Audit Tempo → Denaro",
      subtitle: "Inserisci i tuoi dati reali (niente stime). Per ogni attività lo strumento calcola il verdetto, il vero costo annuo e le ore recuperabili. Scegli la valuta e il periodo del tuo reddito (mese/anno/settimana) — lo strumento si adatta al tuo Paese.",
      profile: {
        sectionTitle: "① Il tuo profilo",
        incomeMonth: "Reddito netto mensile",
        incomeYear: "Reddito netto annuo",
        incomeWeek: "Reddito netto settimanale",
        periodLabel: "Periodo del reddito",
        periodMonth: "al mese",
        periodYear: "all'anno",
        periodWeek: "alla settimana",
        currencyLabel: "Valuta",
        hoursLabel: "Ore / settimana",
        hourlyRate: "→ Tariffa oraria",
        perHour: "/ h",
        invalidHint: "Inserisci un reddito e ore > 0 per calcolare la tariffa oraria.",
        helperPrompt: "Non conosci le tue ore/settimana?",
        helperHoursPerDay: "Ore / giorno",
        helperDaysPerWeek: "Giorni / settimana",
        helperCalc: "Calcola le mie ore",
      },
      tasks: {
        sectionTitle: "② Le tue attività",
        tip: "Suggerimento: scrivi il titolo esatto (verbo + oggetto), es. \"esaminare le proposte\", non \"amministrazione\".",
        colTask: "Attività",
        colHours: "H / sett.",
        colWho: "Chi può farla?",
        colRules: "Regole chiare?",
        colEnergy: "Energia",
        colVerdict: "Verdetto",
        colCost: "Costo / anno",
        colRecovered: "Ore rec.",
        taskPlaceholder: "Nome dell'attività",
        addRow: "+ Aggiungi un'attività",
        addCommon: "+ Aggiungi un'attività comune…",
        addCommonHint: "Non sai cosa aggiungere? Scegli un'attività comune.",
        splitInto: "Suddividi in {n} attività",
      },
      who: { self: "Solo io", specialist: "Uno specialista formato", anyone: "Chiunque sia formato" },
      rules: { yes: "Sì", no: "No" },
      energy: { energizing: "Energizzante", neutral: "Neutra", draining: "Estenuante" },
      verdict: { keep: "✅ MANTIENI", automate: "🤖 AUTOMATIZZA", delegate: "→ DELEGA", rethink: "⚠️ RIPENSA" },
      summary: {
        recoveredHoursYear: "Ore recuperabili / anno",
        recoveredValueYear: "Valore recuperabile / anno",
        toAutomate: "Da automatizzare",
        toDelegate: "Da delegare",
      },
      quickWins: {
        title: "③ Fai questo per primo (Quick-Win)",
        sub: "Attività recuperabili ordinate per impatto (costo/anno) ÷ sforzo. Inizia dall'alto.",
        effortLow: "basso",
        effortMed: "medio",
        effortLabel: "sforzo",
        perYearSuffix: "/anno",
      ...
      cta: {
        headline: "Puoi recuperare {value} all'anno.",
        body: "{count} attività da automatizzare o delegare. Valutiamo l'implementazione in un preventivo su misura.",
        button: "Crea il mio piano di automazione →",
      },
      actions: {
        save: "💾 Salva",
        loadExample: "Carica un esempio",
        reset: "Reimposta",
        savedCloud: "Audit salvato ✓ (cloud + locale)",
        savedLocal: "Audit salvato ✓ (locale su questo dispositivo)",
        needProfile: "Compila il profilo e almeno un'attività.",
        loadOk: "Audit caricato ✓",
        loadFail: "Impossibile caricare.",
        deleteFail: "Impossibile eliminare.",
      },
      savedList: {
        title: "I miei audit salvati",
        perYear: "/anno rec.",
        cloud: "cloud",
        local: "locale",
        load: "Carica",
      ...
      verdictRule: "Verdetto: Solo io + energizzante → Mantieni · altrimenti Ripensa. Altrimenti Chiunque + regole chiare → Automatizza · altrimenti Delega.",
      quoteSeedMain: "Automatizzare / delegare {count} attività individuate tramite l'Audit Tempo → Denaro (≈ {value}/anno recuperabili)",
      quoteSeedTasks: ". Attività: {tasks}.",
      quoteSeedEnd: ".",
    },
    visibility: {
      title: "Autovalutazione Visibilità IA e Social",
      subtitle: "Valuta la tua presenza nelle risposte IA (GEO) e sui social media. Rispondi No / Parziale / Sì; punteggio e raccomandazioni si aggiornano in tempo reale.",
      disclaimer: "Indicatore di maturità dichiarativo: il punteggio riflette le tue risposte, non è una misurazione dei motori IA. Per un audit misurato, richiedi un piano d'azione.",
      choices: { non: "No", partiel: "Parziale", oui: "Sì" },
      dims: {
        geoTitle: "Visibilità IA (GEO / AI Search)",
        geoSub: "Presenza e accuratezza in ChatGPT, Perplexity, Gemini, Google AI.",
        socialTitle: "Social media e contenuti",
        socialSub: "Autorevolezza, metriche utili, costanza, controllo dei contenuti IA.",
      },
      scoreGlobal: "Punteggio complessivo (dichiarativo)",
      note: "Voto",
      answeredOf: "{a}/{t} con risposta",
      empty: "Rispondi alle domande qui sotto — il tuo punteggio di maturità e le raccomandazioni appariranno qui.",
      recosTitle: "Raccomandazioni prioritarie",
      geoTag: "GEO",
      socialTag: "Social",
      cta: {
        headline: "Trasforma il voto {grade} in un piano d'azione.",
        body: "Valutiamo l'implementazione delle tue {count} priorità in un preventivo.",
        button: "Ottieni un piano d'azione / preventivo →",
      },
      reset: "Reimposta",
      questions: {
        byId: {
          geo_offer:      { label: "Gli strumenti IA (ChatGPT, Perplexity, Gemini) descrivono correttamente la tua offerta e i tuoi vantaggi (USP)?", reco: "Pubblica pagine chiare di \"fonte di verità\" (offerta, USP, prezzi) affinché i motori IA citino i fatti giusti." },
          geo_appear:     { label: "Il tuo brand appare nelle risposte IA per le tue query chiave?", reco: "Testa le tue 10 query chiave in ChatGPT/Perplexity; punta alla presenza e correggi le pagine mancanti." },
          geo_cited:      { label: "Il tuo sito è citato come fonte dai motori IA?", reco: "Trova le fonti di terze parti citate (Reddit, Quora, media) dove sei assente → un elenco prioritario di digital PR." },
          geo_competitor: { label: "Sai come l'IA ti confronta con i tuoi concorrenti (chi mette in evidenza)?", reco: "Verifica il posizionamento competitivo nelle risposte IA e individua l'argomento che fa vincere il concorrente." },
          geo_sentiment:  { label: "Il sentiment dell'IA sul tuo brand è positivo e accurato?", reco: "Correggi i fatti negativi/errati alla fonte (il tuo sito) affinché i motori IA aggiornino la loro percezione." },
          geo_structured: { label: "Hai contenuti strutturati (FAQ, schema, pillar page) ottimizzati per essere acquisiti dall'IA?", reco: "Aggiungi FAQ, dati strutturati (schema.org) e pillar page per essere acquisito come fonte di verità." },
          soc_story:      { label: "I tuoi contenuti social costruiscono autorevolezza (storytelling) invece di essere spam di demo?", reco: "Passa dallo spam di funzionalità allo storytelling (fallimenti/successi) per costruire autorevolezza." },
          soc_meetings:   { label: "Misuri gli incontri qualificati generati (oltre like/impression)?", reco: "Monitora la metrica degli \"incontri qualificati\": è ciò che conta, non i like." },
          soc_cadence:    { label: "Pubblichi con una cadenza regolare e sostenibile?", reco: "Imposta un calendario editoriale regolare (una cadenza sostenibile batte i picchi irregolari)." },
          soc_unique:     { label: "I tuoi contenuti riflettono un'expertise unica e difficile da copiare (\"productize yourself\")?", reco: "Metti in risalto il tuo angolo/expertise unico per sfuggire alla concorrenza generica." },
          soc_repurpose:  { label: "Riutilizzi i tuoi contenuti in più formati?", reco: "Riutilizza ogni contenuto in più formati (post, video, carosello) per moltiplicare la portata." },
          soc_oversight:  { label: "I contenuti generati dall'IA sono supervisionati (anti \"Shadow Social\" / allucinazioni)?", reco: "Aggiungi una revisione umana sui contenuti IA per evitare allucinazioni e perdita di autenticità." },
        },
      },
    },
      taskCatalog: {
        groups: {
          admin: "Amministrazione",
          sales: "Vendite e prospezione",
          support: "Assistenza clienti",
          marketing: "Marketing e contenuti",
          finance: "Finanza e HR",
          ops: "Operations",
          strategy: "Strategia",
        },
        tasks: {
          emails_reply: "Rispondere alle email",
          appointments: "Fissare appuntamenti",
          schedule: "Gestione calendario / agenda",
          filing: "Archiviazione documenti",
          cold_calls: "Chiamate a freddo (prospezione)",
          followups: "Follow-up con i clienti",
          quotes_write: "Redazione preventivi",
          crm_entry: "Inserimento dati nel CRM",
          inbound_calls: "Chiamate in entrata (assistenza)",
          support_l1: "Assistenza clienti di primo livello",
          reviews_faq: "Risposte alle recensioni / FAQ",
          content_social: "Creazione contenuti social",
          social_planning: "Pianificazione social media",
          market_research: "Ricerche di mercato / monitoraggio",
          accounting: "Contabilità / fatturazione",
          weekly_report: "Report settimanale",
          cv_screening: "Screening CV / preselezione",
          expenses: "Note spese",
          data_entry: "Inserimento / codifica dati",
          inventory: "Gestione scorte / magazzino",
          translation: "Traduzione contenuti",
          blog_writing: "Scrittura articoli / blog",
          high_prospecting: "Prospezione di alto livello / incontri",
          vision: "Strategia e visione",
          onboarding: "Onboarding clienti",
          email_support: "Email di assistenza clienti",
          email_sales: "Email di follow-up commerciale",
          meetings_internal: "Riunioni interne",
          meetings_client: "Incontri con i clienti",
          content_create: "Creazione di contenuti",
          content_publish: "Pianificazione / pubblicazione",
          invoice_issue: "Emissione fatture",
          quotes_custom: "Preventivi personalizzati",
          interviews: "Colloqui con i candidati",
        },
        hints: {
          calls: "Ambiguo: chiamate IN ENTRATA (assistenza) o IN USCITA (prospezione)? Il verdetto cambia: separale.",
          email: "Sii specifico: assistenza clienti, follow-up commerciali o scambi interni? Ognuno ha un verdetto diverso.",
          meeting: "Interno o con clienti? Ricorrente o una tantum? Gli incontri strategici con i clienti vale la pena mantenerli.",
          content: "Separa la CREAZIONE (giudizio, da mantenere) dalla PUBBLICAZIONE/pianificazione (basata su regole, automatizzabile).",
          invoice: "Emissione standard (regole chiare → automatizza) vs negoziazione/su misura (giudizio → mantieni/delega).",
          report: "Se i dati sono già strutturati, il reporting è spesso automatizzabile.",
          recruit: "Screening CV (criteri chiari → automatizzabile) vs colloquio finale (giudizio umano → da mantenere).",
          data: "Input strutturato? L'inserimento/copia dei dati è quasi sempre automatizzabile.",
          writing: "Prima bozza (copilota IA, rapido) vs validazione/revisione finale (giudizio umano).",
          translate: "Volumi ripetitivi → automatizzabile; sfumature marketing/legali → revisione umana.",
          logistics: "Ottimizzazione percorsi / gestione scorte → automatizzabile; rapporti con i corrieri → umano.",
        },
        seed: {
          emails_slack: "Rispondere a email / Slack",
          accounting_billing: "Contabilità, fatturazione",
          prospecting_clients: "Prospezione / incontri con i clienti",
          crm_data: "Inserimento dati nel CRM",
          social_mgmt: "Gestione dei social media",
          manual_reporting: "Report settimanale manuale",
          planning_agenda: "Gestione calendario / agenda",
          client_quote: "Preventivo per il cliente",
        },
      },
  },
  contacts: {
    nav: "Contatti",
    title: "Contatti",
    subtitleOrg: "Gestisci i contatti e i lead della tua organizzazione.",
    subtitleAll: "Tutti i contatti di ogni organizzazione (sola lettura).",
    modeOrg: "La mia organizzazione",
    modeAll: "Tutte le organizzazioni",
    readOnlyNotice: "Vista cross-organizzazione in sola lettura (operatore della piattaforma). Passa a “La mia organizzazione” per gestire i tuoi contatti.",
    noAccess: "Non hai accesso ai contatti.",
    create: "+ Nuovo contatto",
    searchPlaceholder: "Cerca nome, email, azienda…",
    allTags: "Tutti i tag",
    ...
    colSource: "Origine",
    colCountry: "Paese",
    colLeadStatus: "Stato del lead",
    colLastActivity: "Ultima attività",
    colOwner: "Responsabile",
    colLastMessage: "Ultima richiesta",
    ...
    colActions: "Azioni",
    loading: "Caricamento…",
    empty: "Nessun contatto corrispondente.",
    edit: "Modifica",
    block: "Blocca",
    unblock: "Sblocca",
    delete: "Elimina",
    ...
    phone: "Telefono",
    tagsLabel: "Tag",
    tagsPlaceholder: "tag, separati, da virgole",
    notesLabel: "Note",
    cancel: "Annulla",
    save: "Salva",
    modeCompanies: "Aziende",
    companyName: "Azienda",
    companyContacts: "Contatti",
    companyTwentyId: "ID azienda Twenty",
    companyNoTwentyId: "non collegata",
    companyUpdated: "Aggiornata",
    companySearch: "Cerca azienda o organizzazione…",
    companyEmpty: "Nessuna azienda per ora.",
    companyCount: "aziende",
    companyDuplicate: "DUPLICATO",
    companyRename: "Rinomina",
    companyRenamePrompt: "Nuovo nome azienda:",
    companyMerge: "Unisci",
    companyMergeInto: "Unisci in quella mantenuta",
    companyMergeKeeping: "Mantenuta",
    companyMergePick: "ora scegli il duplicato da unirvi.",
    companyMergeConfirm: "Unire queste aziende? Tutti i contatti passano a quella mantenuta. Operazione irreversibile.",
    companyReconcileDry: "Verifica coerenza",
    companyReconcileApply: "Ripara ora",
    companyReconcileContacts: "Contatti analizzati",
    companyReconcileRegistry: "Aziende nel registro",
    companyReconcileUnlinked: "Contatti senza azienda collegata",
    companyReconcileCreated: "Aziende da creare",
    companyReconcileDuplicates: "Aziende duplicate",
    companyReconcileOrphans: "Aziende senza contatti",
    companyReconcileNoTwenty: "Aziende non collegate a Twenty",
    companyReconcileWritten: "Record scritti",
    companyTwentyCheck: "Verifica Twenty",
    companyTwentyRepair: "Ripara Twenty",
    companyTwentySyncConfirm: "Riparare Twenty ora? Ogni persona collegata all'azienda sbagliata verrà ricollegata all'azienda salvata qui. Questa operazione scrive su Twenty.",
    companyTwentyPeople: "Persone in Twenty",
    companyTwentyChecked: "Verificate",
    companyTwentySkipped: "Ignorate (nessun collegamento azienda)",
    companyTwentyMismatched: "Azienda errata in Twenty",
    companyTwentyCorrected: "Riparate",
    companyTwentyCreated: "Aziende create in Twenty",
    companyTwentyFailures: "Errori",
    modeSales: "Vendite",
    pipelineSection: "Pipeline",
    pipelineStage: "Fase",
    pipelinePriority: "Priorità",
    pipelineNextFollowUp: "Prossimo follow-up",
    pipelineLastContact: "Ultimo contatto",
    pipelineNoNextStep: "Nessun follow-up pianificato",
    pipelineOverdue: "IN RITARDO",
    pipelineLogActivity: "Registra attività",
    pipelineChannel: "Canale",
    pipelineOutcome: "Esito",
    pipelineNoOutcome: "Nessun esito",
    pipelineLog: "Registra",
    pipelineNotePlaceholder: "Cosa è successo? (facoltativo)",
    pipelineRemindIn: "Ricordamelo tra",
    pipelineTimeline: "Cronologia",
    pipelineNoHistory: "Ancora nulla di registrato.",
    pipelineNextSet: "Prossimo follow-up il",
    pipelineBounced: "Indirizzo non recapitabile — nulla pianificato. Correggi prima l'indirizzo.",
    stage_new: "Nuovo",
    stage_assigned: "Assegnato",
    stage_contacted: "Contattato",
    stage_attempted_contact: "Tentativo di contatto",
    stage_qualified: "Qualificato",
    stage_demo_scheduled: "Demo pianificata",
    stage_demo_completed: "Demo effettuata",
    stage_proposal_sent: "Proposta inviata",
    stage_negotiation: "Trattativa",
    stage_won: "Vinto",
    stage_lost: "Perso",
    stage_archived: "Archiviato",
    channel_email: "E-mail",
    channel_sms: "SMS",
    channel_call: "Chiamata",
    channel_note: "Nota",
    priority_low: "Bassa",
    priority_normal: "Normale",
    priority_high: "Alta",
    priority_urgent: "Urgente",
    outcome_connected: "Raggiunto",
    outcome_no_answer: "Nessuna risposta",
    outcome_left_message: "Messaggio lasciato",
    outcome_positive: "Positivo",
    outcome_negative: "Negativo",
    outcome_bounced: "Non recapitabile",
    event_created: "Creato",
    event_signup: "Registrazione",
    event_import: "Importazione",
    event_demo_request: "Richiesta demo",
    event_assigned: "Assegnato",
    event_reassigned: "Riassegnato",
    event_unassigned: "Non assegnato",
    event_status_changed: "Fase",
    event_follow_up_scheduled: "Follow-up",
    event_email: "E-mail",
    event_sms: "SMS",
    event_call: "Chiamata",
    event_note: "Nota",
    event_company_changed: "Azienda",
    event_twenty_synced: "Sync Twenty",
    salesQueue: "Coda follow-up",
    salesQueueClear: "Nulla in ritardo. Ogni lead ha un passo successivo.",
    salesRefresh: "Aggiorna",
    salesLate: "di ritardo",
    salesTotalLeads: "Lead totali",
    salesOpen: "Aperti",
    salesWon: "Vinti",
    salesLost: "Persi",
    salesConversion: "Conversione",
    salesAvgCycle: "Ciclo medio",
    salesFollowUpRate: "Tasso di follow-up",
    salesOverdue: "In ritardo",
    salesDueToday: "In scadenza oggi",
    salesNoNextStep: "Senza passo successivo",
    salesFunnel: "Imbuto",
    salesBySource: "Per origine",
    salesByOwner: "Per responsabile",
    salesByCompany: "Per azienda",
    salesByOrg: "Per organizzazione",
    salesConvHint: "totale / conversione dei lead decisi",
    salesScope: "Ambito",
    salesScopeAll: "tutti i lead",
    salesScopeAssigned: "lead assegnati a te",
    unassigned: "Non assegnato",
    assignmentSection: "Assegnazione",
    assignedTo: "Assegnato a",
    assignedBy: "Assegnato da",
    assignedAt: "Assegnato il",
    lastReassignedBy: "Ultima riassegnazione da",
    lastReassignedAt: "Ultima riassegnazione il",
    assignTo: "Assegna a",
    assign: "Assegna",
    transfer: "Trasferisci",
    importCsv: "Importa",
    importTitle: "Importa contatti",
    importHelp: "Scegli un file e l'importazione parte subito. I duplicati vengono ignorati automaticamente.",
    importRowsFound: "righe trovate",
    importBatches: "lotti",
    importProgress: "Importazione lotto",
    importImported: "importati",
    importRejected: "righe ignorate",
    importStart: "Avvia importazione",
    importFormats: "Supportati: CSV (consigliato) ed Excel .xlsx. Da Google Sheets: File → Scarica → Valori separati da virgola.",
    importColumns: "Colonne",
    importRequired: "Obbligatorie",
    importOptional: "Facoltative",
    importChooseFile: "Scegli file",
    importSample: "Scarica esempio",
    importStageReading: "Lettura del file…",
    importStageValidating: "Validazione righe…",
    importStageImporting: "Importazione…",
    importStageDone: "Completato",
    importFailed: "non riuscite",
    pageSize: "per pagina",
    loadMore: "Carica altri",
    loadedCount: "caricati",
    scannedCount: "letti",
    importErrors: {
      UNSUPPORTED_FORMAT: "Formato non supportato. Salva il file come .csv o .xlsx.",
      NOT_A_ZIP: "Questo file non è una cartella di lavoro .xlsx leggibile.",
      NO_WORKSHEET: "Questa cartella di lavoro non contiene fogli.",
      UNSUPPORTED_COMPRESSION: "Questa cartella di lavoro usa una compressione non supportata. Salvala di nuovo o esporta in CSV.",
      CORRUPT_FILE: "Impossibile leggere il file. Salvalo di nuovo o esporta in CSV.",
      EMPTY_FILE: "Questo file non contiene righe di dati.",
      NO_EMAIL_COLUMN: "Nessuna colonna e-mail trovata. Aggiungi una colonna «Email».",
      INVALID_EMAIL: "E-mail non valida",
      DUPLICATE_IN_FILE: "Duplicato nel file",
      DUPLICATE_EXISTING: "Già nel CRM",
      MISSING_NAME: "Nome mancante",
      MISSING_COMPANY: "Azienda mancante",
      INVALID_PHONE: "Telefono non valido",
      INVALID_COUNTRY: "Paese non valido",
      WRITE_FAILED: "Salvataggio non riuscito",
    },
    sources: {
      manual: "Manuale",
      quote: "Preventivo",
      worksheet: "Foglio di lavoro",
      visibility: "Audit di visibilità",
      import: "Importazione",
      demo_request: "Richiesta demo",
    ...
    errors: {
      DUPLICATE_EMAIL: "Esiste già un contatto con questa email in questa organizzazione.",
      FORBIDDEN: "Puoi gestire solo i contatti assegnati a te.",
      FORBIDDEN_STATUS: "Solo un proprietario o un amministratore può bloccare o modificare lo stato di un contatto.",
      FORBIDDEN_ASSIGN: "Solo un super amministratore può assegnare un contatto a un altro utente.",
      NOT_A_MEMBER: "Questo utente non è un membro attivo di questo spazio di lavoro.",
      MEMBER_DISABLED: "Questo membro è disattivato.",
      BATCH_TOO_LARGE: "Questo lotto è troppo grande. Dividi il file.",
      DUPLICATE_COMPANY: "Un'altra azienda usa già questo nome. Uniscile invece.",
      INVALID_NAME: "È richiesto un nome azienda.",
      SAME_COMPANY: "Un'azienda non può essere unita a se stessa.",
      ALREADY_MERGED: "Questa azienda è già stata unita.",
      CROSS_ORG_MERGE: "Aziende di organizzazioni diverse non possono essere unite.",
      IMPORT_FAILED: "L'importazione si è interrotta. Le righe già importate sono state salvate.",
      INVALID_INPUT: "Controlla i dettagli del contatto (nome ed email validi sono obbligatori).",
      NOT_FOUND: "Questo contatto non esiste più.",
      LOAD_FAILED: "Impossibile caricare i contatti.",
   ...
   */
  enrichment: {
    title: 'Sistemi di IA osservati nelle fonti pubbliche',
    subtitle: 'Prove pubbliche confrontate con il tuo registro IA per',
    loading: 'Caricamento dello snapshot delle prove…',
    loadError: 'Non è stato possibile caricare le prove di questo report.',
    notFound: 'A questo report non è associato alcuno snapshot di prove.',
    integrityFailed: 'Questo snapshot di prove non corrisponde più alla sua impronta registrata e non può essere visualizzato.',
    disclaimer: 'Le prove sono state raccolte da fonti accessibili al pubblico alla data e ora indicate. I risultati descrivono ciò che è stato osservato e ciò che è stato dichiarato; non costituiscono una conclusione legale né una certificazione.',
    snapshotId: 'Snapshot',
    capturedAt: 'Acquisito il',
    surface: 'Tipo di audit',
    ...
    coverageTitle: 'Che cosa è stato analizzato',
    coverageNone: 'Per questo snapshot non è stata tentata alcuna fonte.',
    sourcesRead: 'Fonti lette correttamente',
    coverageIncomplete: 'La copertura è incompleta. Le fonti elencate sopra non sono state lette, quindi questa sezione non è una visione esaustiva del tuo uso dell’IA.',
    dropped: '{n} osservazione/i aggiuntiva/e sono state scartate perché lo snapshot ha raggiunto il limite di prove.',
    covRead: 'Letta',
    covPartial: 'Letta parzialmente',
    covRateLimited: 'Limite di frequenza',
    covUnavailable: 'Fonte non disponibile',
    covBlocked: 'Bloccata',
    covNotAnalyzed: 'Non analizzata',
    observedTitle: 'Sistemi osservati',
    observedNone: 'Nessun sistema di IA è stato identificato nelle fonti lette.',
    isDeclared: 'dichiarato',
    notDeclared: 'non dichiarato',
    declaredTitle: 'Sistemi dichiarati (registro IA)',
    declaredNone: 'Il tuo registro IA non contiene alcuna voce attiva.',
    corroborated: 'confermato',
    noPublicEvidence: 'nessuna prova pubblica',
    cannotCompare: 'non confrontabile',
    findingsTitle: 'Risultati',
    findingsNone: 'Non è stato rilevato alcuno scarto tra i sistemi osservati nelle fonti pubbliche e quelli registrati nel tuo registro IA.',
    impactTotal: '{n} risultato/i. Impatto di conformità applicato al tuo punteggio: {points} punto/i.',
    capped: 'limitato',
    ...
    ruleId: 'Regola',
    subject: 'Soggetto',
    complianceImpact: 'Impatto di conformità',
    impactNone: 'nessuno (solo segnalato)',
    evidenceTitle: 'Prove',
    evidenceAbsence: 'Questo risultato si basa sull’assenza di un’osservazione, quindi non cita alcuna prova acquisita.',
    evidenceId: 'ID prova',
    hash: 'Hash',
    comparisonTitle: 'Osservato vs dichiarato',
    observedLabel: 'Osservato',
    declaredLabel: 'Dichiarato',
    gapLabel: 'Scarto',
    notObserved: 'non osservato nelle fonti pubbliche',
    noRegistryEntry: 'nessuna voce corrispondente nel registro IA',
    gapUndeclared: 'Osservato ma non dichiarato',
    gapUnverified: 'Dichiarato ma non osservato',
    gapIncomplete: 'Voce del registro non confrontabile',
