...
export const it: Dict = {
  ...
  contacts: {
    ...
    importHelp: "Carica un CSV con almeno una colonna e-mail. Nome e azienda sono obbligatori su ogni riga; telefono e paese sono facoltativi. I duplicati vengono ignorati.",
