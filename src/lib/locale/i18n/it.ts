...
export const it: Dict = {
  ...
  invoices: {
    ...
    nextNegotiation: 'Avanti: esamina il budget del cliente, poi imposta l’importo finale.',
  ...
  adminCenter: {
    ...
    evtAccepted: 'Budget convalidato dal cliente',
    evtAdjustment: 'Il cliente ha richiesto una modifica del budget',
    ...
    superadminHeading: 'Visibilità superadmin — tutti i preventivi',
  ...
  myQuotes: {
    ...
    subtitle: 'Tieni traccia delle proposte che hai inviato — stato, budget e l’ultima attività.',
    loading: 'Caricamento…',
    ...
    actAccepted: 'Il cliente ha accettato il budget',
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "send": {
        ...
        "intro": "Inserisci l'email del tuo cliente e il budget proposto — invieremo loro la proposta via email per accettarla o richiedere modifiche.",
        ...
        "hint": "Il tuo cliente riceve la proposta e accetta il budget o richiede modifiche.",
      ...
      "accepted": {
        "bankProceedCta": "Procedi con il bonifico bancario",
        ...
        "confirmTitle": "Conferma il budget proposto",
        "confirmBody": "Conferma per accettare il budget proposto: prepareremo la tua fattura e avviseremo il nostro team.",
        "confirmCta": "Accetta il budget proposto",
