...
export const es: Dict = {
  ...
  contacts: {
    ...
    importHelp: "Sube un CSV con al menos una columna de correo electrónico. El nombre y la empresa son obligatorios en cada fila; el teléfono y el país son opcionales. Los duplicados se omiten.",
