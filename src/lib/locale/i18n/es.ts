...
export const es: Dict = {
  ...
  invoices: {
    ...
    sentNoEmail: 'No se pudo enviar el correo.',
    confirmationResent: 'Confirmación de pago reenviada',
    confirmationSentOn: 'Confirmación de pago enviada',
    invoiceSentOn: 'Correo de la factura enviado',
    resendNoRecipient: 'Esta factura no tiene correo del cliente.',
    resendConfirmationBtn: 'Reenviar la confirmación de pago',
    downloadPdf: 'Descargar la factura (PDF)',
  ...
  adminCenter: {
    ...
    evtSent: 'Propuesta enviada',
    evtAccepted: 'Presupuesto aceptado por el cliente',
  ...
  myQuotes: {
    ...
    subtitle: 'Sigue las propuestas que has enviado: estado, precio y la última actividad.',
    loading: 'Cargando…',
    ...
    quoteLabel: 'Presupuesto',
    proposedBudget: 'Precio del presupuesto',
    statusSent: 'Enviado',
  ...
  auth: {
    ...
    "error": { "companyRequired": "La empresa es obligatoria." },
    "field": {
  ...
  dashboardHome: {
    ...
    "cta": {
      ...
      "demoModal": {
        ...
        "labelCountry": "País",
        "errorCountry": "Por favor selecciona un país.",
        "placeholderPhone": "Número de teléfono",
        "errorPhone": "Se requiere un número de teléfono válido.",
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "send": {
        ...
        "intro": "Introduce el correo de tu cliente: le enviaremos la propuesta con el precio del presupuesto, lista para aprobar en línea.",
        ...
        "hint": "Tu cliente recibe la propuesta y aprueba el presupuesto en línea.",
      ...
      "accepted": {
        "bankProceedCta": "Validar — recibir las instrucciones de transferencia",
        ...
        "s1": "Factura generada: disponible de inmediato",
        "s2": "Pago seguro en línea o por transferencia",
        "s3": "Confirmación de pago por correo",
        "s4": "Nuestro equipo lanza tu proyecto",
        "step1": "Tu factura se genera al instante",
        "step2": "Paga en línea con tarjeta o por transferencia",
        "step3": "Recibes una confirmación de pago por correo",
        "step4": "Nuestro equipo pone en marcha tu proyecto",
        ...
        "confirmTitle": "Valida tu presupuesto",
        "confirmBody": "Un clic genera tu factura al instante: accedes al pago seguro (tarjeta o transferencia) y nuestro equipo empieza a preparar tu proyecto.",
        "confirmCta": "Validar y recibir mi factura",
        "confirming": "Generando tu factura…",
      ...
      "flow": {
        ...
        "s2": "Tu factura se genera al instante",
        "s3": "Paga con tarjeta o transferencia",
        "s4": "El proyecto comienza"
      },
      "decision": {
        "priceLabel": "Inversión recomendada",
        "valueItem1": "Entrega de extremo a extremo: alcance, desarrollo, despliegue y traspaso incluidos",
        "valueItem2": "Un equipo de expertos dedicado, con acompañamiento en cada etapa",
        "valueItem3": "Alcance validado contigo antes de facturar nada",
        "priceNote": "Sin pago hoy: la factura solo se emite tras tu aprobación de la propuesta. Pago seguro con tarjeta o transferencia.",
        "impactHeading": "Lo que este proyecto cambia para tu negocio",
        "impact1": "Horas de trabajo manual automatizadas cada semana: tu equipo se centra en tareas de valor",
        "impact2": "Menos errores manuales y un cumplimiento listo para auditorías",
        "impact3": "Capacidad de crecer sin aumentar la plantilla",
      ...
      "status": {
        ...
        "payNow": "Pagar ahora",
        "paidThanks": "Pago recibido, ¡gracias! Tu correo de confirmación está en camino y nuestro equipo pone en marcha tu proyecto.",
        ...
        "budgetLabel": "Importe del presupuesto",
  ...
  contacts: {
    ...
    colSource: "Fuente",
    colCountry: "País",
    colLeadStatus: "Estado del lead",
    colLastActivity: "Última actividad",
    colOwner: "Responsable",
    colLastMessage: "Última solicitud",
    ...
    companyTwentyId: "ID de empresa en Twenty",
    companyNoTwentyId: "sin vincular",
    companyUpdated: "Actualizado",
    companySearch: "Buscar empresa u organización…",
    companyEmpty: "Todavía no hay empresas.",
    companyCount: "empresas",
    companyDuplicate: "DUPLICADA",
    companyRename: "Renombrar",
    companyRenamePrompt: "Nuevo nombre de la empresa:",
    companyMerge: "Fusionar",
    companyMergeInto: "Fusionar en la conservada",
    companyMergeKeeping: "Conservando",
    companyMergePick: "ahora elige la duplicada que se va a fusionar.",
    companyMergeConfirm: "¿Fusionar estas empresas? Todos los contactos pasan a la empresa conservada. No se puede deshacer.",
    companyReconcileDry: "Comprobar consistencia",
    companyReconcileApply: "Reparar ahora",
    companyReconcileContacts: "Contactos analizados",
    companyReconcileRegistry: "Empresas en el registro",
    companyReconcileUnlinked: "Contactos sin empresa vinculada",
    companyReconcileCreated: "Empresas que se crearían",
    companyReconcileDuplicates: "Empresas duplicadas",
    companyReconcileOrphans: "Empresas sin contactos",
    companyReconcileNoTwenty: "Empresas no vinculadas a Twenty",
    companyReconcileWritten: "Registros escritos",
    companyTwentyCheck: "Comprobar Twenty",
    companyTwentyRepair: "Reparar Twenty",
    companyTwentySyncConfirm: "¿Reparar Twenty ahora? Cada persona vinculada a la empresa incorrecta se reasignará a la empresa guardada aquí. Esto escribe en Twenty.",
    companyTwentyPeople: "Personas en Twenty",
    companyTwentyChecked: "Comprobadas",
    companyTwentySkipped: "Omitidas (sin empresa vinculada)",
    companyTwentyMismatched: "Empresa incorrecta en Twenty",
    companyTwentyCorrected: "Reparadas",
    companyTwentyCreated: "Empresas creadas en Twenty",
    companyTwentyFailures: "Fallos",
    modeSales: "Ventas",
    pipelineSection: "Embudo",
    pipelineStage: "Etapa",
    pipelinePriority: "Prioridad",
    pipelineNextFollowUp: "Próximo seguimiento",
    pipelineLastContact: "Último contacto",
    pipelineNoNextStep: "Sin seguimiento programado",
    pipelineOverdue: "VENCIDO",
    pipelineLogActivity: "Registrar actividad",
    pipelineChannel: "Canal",
    pipelineOutcome: "Resultado",
    pipelineNoOutcome: "Sin resultado",
    pipelineLog: "Registrar",
    pipelineNotePlaceholder: "¿Qué ocurrió? (opcional)",
    pipelineRemindIn: "Recordarme en",
    pipelineTimeline: "Historial",
    pipelineNoHistory: "Todavía no hay nada registrado.",
    pipelineNextSet: "Próximo seguimiento el",
    pipelineBounced: "Dirección rebotada: no se programó nada. Corrige la dirección primero.",
    stage_new: "Nuevo",
    stage_assigned: "Asignado",
    stage_contacted: "Contactado",
    stage_attempted_contact: "Intento de contacto",
    stage_qualified: "Cualificado",
    stage_demo_scheduled: "Demo programada",
    stage_demo_completed: "Demo realizada",
    stage_proposal_sent: "Propuesta enviada",
    ...
    outcome_left_message: "Mensaje dejado",
    outcome_positive: "Positivo",
    outcome_negative: "Negativo",
    outcome_bounced: "Rebotado",
    event_created: "Creado",
    event_signup: "Registro",
    event_import: "Importación",
    event_demo_request: "Solicitud de demo",
    event_assigned: "Asignado",
    event_reassigned: "Reasignado",
    event_unassigned: "Sin asignar",
    event_status_changed: "Etapa",
    event_follow_up_scheduled: "Seguimiento",
    event_email: "Correo",
    event_sms: "SMS",
    event_call: "Llamada",
    event_note: "Nota",
    ...
    salesQueue: "Cola de seguimiento",
    salesQueueClear: "Nada vencido. Cada lead tiene un próximo paso.",
    salesRefresh: "Actualizar",
    salesLate: "de retraso",
    salesTotalLeads: "Leads totales",
    salesOpen: "Abiertos",
    salesWon: "Ganados",
    salesLost: "Perdidos",
    salesConversion: "Conversión",
    salesAvgCycle: "Ciclo medio",
    salesFollowUpRate: "Tasa de seguimiento",
    salesOverdue: "Vencidos",
    salesDueToday: "Para hoy",
    salesNoNextStep: "Sin próximo paso",
    salesFunnel: "Embudo",
    salesBySource: "Por origen",
    salesByOwner: "Por responsable",
    salesByCompany: "Por empresa",
    salesByOrg: "Por organización",
    salesConvHint: "total / conversión de leads decididos",
    salesScope: "Alcance",
    salesScopeAll: "todos los leads",
    salesScopeAssigned: "leads asignados a ti",
    unassigned: "Sin asignar",
    assignmentSection: "Asignación",
    assignedTo: "Asignado a",
    assignedBy: "Asignado por",
    assignedAt: "Asignado el",
    lastReassignedBy: "Última reasignación por",
    lastReassignedAt: "Última reasignación el",
    assignTo: "Asignar a",
    assign: "Asignar",
    transfer: "Transferir",
    importCsv: "Importar",
    importTitle: "Importar contactos",
    importHelp: "Elige un archivo y la importación empieza de inmediato. Los duplicados se omiten automáticamente.",
    importRowsFound: "filas encontradas",
    importBatches: "lotes",
    importProgress: "Importando lote",
    importImported: "importados",
    importRejected: "filas omitidas",
    importStart: "Iniciar importación",
    importFormats: "Compatibles: CSV (recomendado) y Excel .xlsx. Desde Google Sheets: Archivo → Descargar → Valores separados por comas.",
    importColumns: "Columnas",
    importRequired: "Obligatorias",
    importOptional: "Opcionales",
    importChooseFile: "Elegir archivo",
    importSample: "Descargar ejemplo",
    importStageReading: "Leyendo el archivo…",
    importStageValidating: "Validando filas…",
    importStageImporting: "Importando…",
    importStageDone: "Completado",
    importFailed: "con error",
    pageSize: "por página",
    loadMore: "Cargar más",
    loadedCount: "cargados",
    scannedCount: "leídos",
    importErrors: {
      UNSUPPORTED_FORMAT: "Ese formato no es compatible. Guarda el archivo como .csv o .xlsx.",
      NOT_A_ZIP: "Ese archivo no es un libro .xlsx legible.",
      NO_WORKSHEET: "Ese libro no tiene ninguna hoja de cálculo.",
      UNSUPPORTED_COMPRESSION: "Ese libro usa una compresión no compatible. Vuelve a guardarlo o expórtalo como CSV.",
      CORRUPT_FILE: "No se pudo leer ese archivo. Vuelve a guardarlo o expórtalo como CSV.",
      EMPTY_FILE: "Ese archivo no tiene filas de datos.",
      NO_EMAIL_COLUMN: "No se encontró una columna de correo electrónico. Añade una columna «Email».",
      INVALID_EMAIL: "Correo no válido",
      DUPLICATE_IN_FILE: "Duplicado en el archivo",
      DUPLICATE_EXISTING: "Ya está en el CRM",
      MISSING_NAME: "Falta el nombre",
      MISSING_COMPANY: "Falta la empresa",
    ...
    errors: {
      ...
      FORBIDDEN: "Solo puedes gestionar los contactos que tienes asignados.",
      FORBIDDEN_STATUS: "Solo un propietario o administrador puede bloquear o cambiar el estado de un contacto.",
      FORBIDDEN_ASSIGN: "Solo un superadministrador puede asignar un contacto a otro usuario.",
      NOT_A_MEMBER: "Ese usuario no es un miembro activo de este espacio de trabajo.",
      MEMBER_DISABLED: "Ese miembro está desactivado.",
      BATCH_TOO_LARGE: "Ese lote es demasiado grande. Divide el archivo.",
      DUPLICATE_COMPANY: "Otra empresa ya usa ese nombre. Fusiónalas en su lugar.",
      INVALID_NAME: "Se requiere un nombre de empresa.",
      SAME_COMPANY: "Una empresa no se puede fusionar consigo misma.",
      ALREADY_MERGED: "Esa empresa ya fue fusionada.",
      CROSS_ORG_MERGE: "No se pueden fusionar empresas de organizaciones distintas.",
      IMPORT_FAILED: "La importación se detuvo. Las filas ya importadas se guardaron.",
   ...
   */
  enrichment: {
    title: 'Sistemas de IA observados en fuentes públicas',
    subtitle: 'Pruebas públicas comparadas con tu registro de IA para',
    loading: 'Cargando la instantánea de pruebas…',
    loadError: 'No se han podido cargar las pruebas de este informe.',
    notFound: 'Este informe no tiene ninguna instantánea de pruebas asociada.',
    integrityFailed: 'Esta instantánea de pruebas ya no coincide con su huella registrada y no puede mostrarse.',
    disclaimer: 'Las pruebas se recopilaron de fuentes de acceso público en la marca temporal indicada. Los hallazgos describen lo observado y lo declarado; no son una conclusión jurídica ni una certificación.',
    snapshotId: 'Instantánea',
    capturedAt: 'Capturada el',
    surface: 'Tipo de auditoría',
    fingerprint: 'Huella',
    ...
    coverageTitle: 'Qué se ha analizado',
    coverageNone: 'No se ha intentado ninguna fuente para esta instantánea.',
    sourcesRead: 'Fuentes leídas correctamente',
    coverageIncomplete: 'La cobertura fue incompleta. Las fuentes indicadas arriba no se leyeron, por lo que esta sección no es una visión exhaustiva de tu uso de la IA.',
    dropped: 'Se descartaron {n} observación(es) adicional(es) porque la instantánea alcanzó su límite de pruebas.',
    covRead: 'Leída',
    covPartial: 'Leída parcialmente',
    covRateLimited: 'Límite de peticiones',
    covUnavailable: 'Fuente no disponible',
    covBlocked: 'Bloqueada',
    covNotAnalyzed: 'No analizada',
    observedTitle: 'Sistemas observados',
    observedNone: 'No se ha identificado ningún sistema de IA en las fuentes leídas.',
    isDeclared: 'declarado',
    notDeclared: 'no declarado',
    declaredTitle: 'Sistemas declarados (registro de IA)',
    declaredNone: 'Tu registro de IA no contiene ninguna entrada activa.',
    corroborated: 'corroborado',
    noPublicEvidence: 'sin pruebas públicas',
    cannotCompare: 'no comparable',
    findingsTitle: 'Hallazgos',
    findingsNone: 'No se ha encontrado ninguna brecha entre los sistemas observados en fuentes públicas y los registrados en tu registro de IA.',
    impactTotal: '{n} hallazgo(s). Impacto de cumplimiento aplicado a tu puntuación: {points} punto(s).',
    capped: 'limitado',
    ...
    ruleId: 'Regla',
    subject: 'Sujeto',
    complianceImpact: 'Impacto de cumplimiento',
    impactNone: 'ninguno (solo informativo)',
    evidenceTitle: 'Pruebas',
    evidenceAbsence: 'Este hallazgo se basa en la ausencia de una observación, por lo que no cita ninguna prueba capturada.',
    evidenceId: 'ID de prueba',
    hash: 'Hash',
    comparisonTitle: 'Observado frente a declarado',
    observedLabel: 'Observado',
    declaredLabel: 'Declarado',
    gapLabel: 'Brecha',
    notObserved: 'no observado en fuentes públicas',
    noRegistryEntry: 'sin entrada correspondiente en el registro de IA',
    gapUndeclared: 'Observado pero no declarado',
    gapUnverified: 'Declarado pero no observado',
    gapIncomplete: 'Entrada del registro no comparable',
