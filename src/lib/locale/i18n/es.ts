...
export const es: Dict = {
  ...
  invoices: {
    ...
    sentNoEmail: 'Factura confirmada, pero no se pudo enviar el correo.',
  ...
  tokensPage: {
    ...
    "packs": {
      "sectionTitle": "Compra más tokens",
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "accepted": {
        ...
        "confirmBody": "Confirma para aceptar esta propuesta — prepararemos tu factura y avisaremos a nuestro equipo.",
        "confirmCta": "Confirmar aceptación",
