...
export const fr: Dict = {
  ...
  contacts: {
    ...
    cancel: "Annuler",
    save: "Enregistrer",
    modeCompanies: "Sociétés",
    companyName: "Société",
    companyContacts: "Contacts",
    companyTwentyId: "ID société Twenty",
    companyNoTwentyId: "non lié",
    companyUpdated: "Mis à jour",
    companySearch: "Rechercher une société ou une organisation…",
    companyEmpty: "Aucune société pour le moment.",
    companyCount: "sociétés",
    companyDuplicate: "DOUBLON",
    companyRename: "Renommer",
    companyRenamePrompt: "Nouveau nom de société :",
    companyMerge: "Fusionner",
    companyMergeInto: "Fusionner dans la conservée",
    companyMergeKeeping: "Conservée",
    companyMergePick: "choisissez maintenant le doublon à y fusionner.",
    companyMergeConfirm: "Fusionner ces sociétés ? Tous les contacts passent à la société conservée. Action irréversible.",
    companyReconcileDry: "Vérifier la cohérence",
    companyReconcileApply: "Réparer maintenant",
    companyReconcileContacts: "Contacts analysés",
    companyReconcileRegistry: "Sociétés au registre",
    companyReconcileUnlinked: "Contacts sans lien société",
    companyReconcileCreated: "Sociétés à créer",
    companyReconcileDuplicates: "Sociétés en double",
    companyReconcileOrphans: "Sociétés sans contact",
    companyReconcileNoTwenty: "Sociétés non liées à Twenty",
    companyReconcileWritten: "Enregistrements écrits",
    companyTwentyCheck: "Vérifier Twenty",
    companyTwentyRepair: "Réparer Twenty",
    companyTwentySyncConfirm: "Réparer Twenty maintenant ? Chaque personne liée à la mauvaise société sera rattachée à la société enregistrée ici. Cette action écrit dans Twenty.",
    companyTwentyPeople: "Personnes dans Twenty",
    companyTwentyChecked: "Vérifiées",
    companyTwentySkipped: "Ignorées (aucun lien société)",
    companyTwentyMismatched: "Mauvaise société dans Twenty",
    companyTwentyCorrected: "Réparées",
    companyTwentyCreated: "Sociétés créées dans Twenty",
    companyTwentyFailures: "Échecs",
    modeSales: "Ventes",
    pipelineSection: "Pipeline",
    pipelineStage: "Étape",
    pipelinePriority: "Priorité",
    pipelineNextFollowUp: "Prochaine relance",
    pipelineLastContact: "Dernier contact",
    pipelineNoNextStep: "Aucune relance planifiée",
    pipelineOverdue: "EN RETARD",
    pipelineLogActivity: "Enregistrer une action",
    pipelineChannel: "Canal",
    pipelineOutcome: "Résultat",
    pipelineNoOutcome: "Aucun résultat",
    pipelineLog: "Enregistrer",
    pipelineNotePlaceholder: "Que s'est-il passé ? (facultatif)",
    pipelineRemindIn: "Me rappeler dans",
    pipelineTimeline: "Historique",
    pipelineNoHistory: "Rien enregistré pour le moment.",
    pipelineNextSet: "Prochaine relance prévue le",
    pipelineBounced: "Adresse en erreur — rien planifié. Corrigez d'abord l'adresse.",
    stage_new: "Nouveau",
    stage_assigned: "Attribué",
    stage_contacted: "Contacté",
    stage_attempted_contact: "Tentative de contact",
    stage_qualified: "Qualifié",
    stage_demo_scheduled: "Démo planifiée",
    stage_demo_completed: "Démo réalisée",
    stage_proposal_sent: "Proposition envoyée",
    stage_negotiation: "Négociation",
    stage_won: "Gagné",
    stage_lost: "Perdu",
    stage_archived: "Archivé",
    ...
    outcome_connected: "Joint",
    outcome_no_answer: "Sans réponse",
    outcome_left_message: "Message laissé",
    outcome_positive: "Positif",
    outcome_negative: "Négatif",
    outcome_bounced: "Adresse en erreur",
    event_created: "Créé",
    event_signup: "Inscription",
    event_import: "Import",
    event_demo_request: "Demande de démo",
    event_assigned: "Attribué",
    event_reassigned: "Réattribué",
    event_unassigned: "Non attribué",
    event_status_changed: "Étape",
    event_follow_up_scheduled: "Relance",
    event_email: "E-mail",
    event_sms: "SMS",
    event_call: "Appel",
    event_note: "Note",
    event_company_changed: "Société",
    event_twenty_synced: "Sync Twenty",
    salesQueue: "File de relance",
    salesQueueClear: "Aucun retard. Chaque prospect a une prochaine étape.",
    salesRefresh: "Actualiser",
    salesLate: "de retard",
    salesTotalLeads: "Prospects",
    salesOpen: "En cours",
    salesWon: "Gagnés",
    salesLost: "Perdus",
    salesConversion: "Conversion",
    salesAvgCycle: "Cycle moyen",
    salesFollowUpRate: "Taux de relance",
    salesOverdue: "En retard",
    salesDueToday: "Prévu aujourd'hui",
    salesNoNextStep: "Sans prochaine étape",
    salesFunnel: "Entonnoir",
    salesBySource: "Par source",
    salesByOwner: "Par responsable",
    salesByCompany: "Par société",
    salesByOrg: "Par organisation",
    salesConvHint: "total / conversion des prospects décidés",
    salesScope: "Périmètre",
    salesScopeAll: "tous les prospects",
    salesScopeAssigned: "prospects qui vous sont attribués",
    ...
    errors: {
      ...
      DUPLICATE_COMPANY: "Une autre société porte déjà ce nom. Fusionnez-les à la place.",
      INVALID_NAME: "Un nom de société est requis.",
      SAME_COMPANY: "Une société ne peut pas être fusionnée avec elle-même.",
      ALREADY_MERGED: "Cette société a déjà été fusionnée.",
      CROSS_ORG_MERGE: "Des sociétés de différentes organisations ne peuvent pas être fusionnées.",
   ...
   */
  enrichment: {
    title: 'Systèmes d’IA observés dans les sources publiques',
    subtitle: 'Preuves publiques comparées à votre registre IA pour',
    loading: 'Chargement de l’instantané de preuves…',
    loadError: 'Les preuves de ce rapport n’ont pas pu être chargées.',
    notFound: 'Aucun instantané de preuves n’est associé à ce rapport.',
    integrityFailed: 'Cet instantané de preuves ne correspond plus à son empreinte enregistrée et ne peut pas être affiché.',
    disclaimer: 'Les preuves ont été collectées dans des sources accessibles au public à l’horodatage indiqué. Les constats décrivent ce qui a été observé et ce qui a été déclaré ; ils ne constituent ni une conclusion juridique ni une certification.',
    snapshotId: 'Instantané',
    capturedAt: 'Capturé le',
    surface: 'Type d’audit',
    ...
    coverageTitle: 'Ce qui a été analysé',
    coverageNone: 'Aucune source n’a été tentée pour cet instantané.',
    sourcesRead: 'Sources lues avec succès',
    coverageIncomplete: 'La couverture est incomplète. Les sources listées ci-dessus n’ont pas été lues : cette section n’est donc pas une vue exhaustive de votre usage de l’IA.',
    dropped: '{n} observation(s) supplémentaire(s) ont été écartées car l’instantané a atteint sa limite de preuves.',
    covRead: 'Lue',
    covPartial: 'Lue partiellement',
    covRateLimited: 'Limitée par le débit',
    covUnavailable: 'Source indisponible',
    covBlocked: 'Bloquée',
    covNotAnalyzed: 'Non analysée',
    observedTitle: 'Systèmes observés',
    observedNone: 'Aucun système d’IA n’a été identifié dans les sources lues.',
    isDeclared: 'déclaré',
    notDeclared: 'non déclaré',
    declaredTitle: 'Systèmes déclarés (registre IA)',
    declaredNone: 'Votre registre IA ne contient aucune entrée active.',
    corroborated: 'corroboré',
    noPublicEvidence: 'aucune preuve publique',
    cannotCompare: 'non comparable',
    findingsTitle: 'Constats',
    findingsNone: 'Aucun écart n’a été trouvé entre les systèmes observés dans les sources publiques et ceux enregistrés dans votre registre IA.',
    impactTotal: '{n} constat(s). Impact de conformité appliqué à votre score : {points} point(s).',
    capped: 'plafonné',
    ...
    ruleId: 'Règle',
    subject: 'Sujet',
    complianceImpact: 'Impact de conformité',
    impactNone: 'aucun (signalé uniquement)',
    evidenceTitle: 'Preuves',
    evidenceAbsence: 'Ce constat repose sur l’absence d’observation ; il ne cite donc aucune preuve capturée.',
    evidenceId: 'ID de preuve',
    hash: 'Empreinte',
    comparisonTitle: 'Observé vs déclaré',
    observedLabel: 'Observé',
    declaredLabel: 'Déclaré',
    gapLabel: 'Écart',
    notObserved: 'non observé dans les sources publiques',
    noRegistryEntry: 'aucune entrée correspondante dans le registre IA',
    gapUndeclared: 'Observé mais non déclaré',
    gapUnverified: 'Déclaré mais non observé',
    gapIncomplete: 'Entrée de registre non comparable',
