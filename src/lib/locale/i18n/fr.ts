...
export const fr: Dict = {
  ...
  adminCenter: {
    ...
    evtAccepted: 'Accepté par le client',
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "accepted": {
        ...
        "confirmTitle": "Veuillez confirmer votre demande",
        "confirmBody": "Confirmez pour accepter cette proposition — nous préparerons votre facture et préviendrons notre équipe.",
        "confirmCta": "Confirmer l'acceptation",
