...
export const fr: Dict = {
  ...
  invoices: {
    ...
    nextNegotiation: 'Étape suivante : examinez le budget du client, puis définissez le montant final.',
  ...
  myQuotes: {
    title: 'Mes devis',
    subtitle: 'Suivez les propositions que vous avez envoyées — statut, budget et dernière activité.',
    loading: 'Chargement…',
    ...
    actAccepted: 'Le client a accepté le budget',
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "accepted": {
        ...
        "confirmTitle": "Confirmer le budget proposé",
        "confirmBody": "Confirmez pour accepter le budget proposé — nous préparerons votre facture et préviendrons notre équipe.",
        "confirmCta": "Accepter le budget proposé",
  ...
  contacts: {
    ...
    errors: {
      ...
      FORBIDDEN: "Vous ne pouvez gérer que les contacts que vous avez créés.",
