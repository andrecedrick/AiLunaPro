...
export const fr: Dict = {
  ...
  contacts: {
    ...
    importHelp: "Importez un CSV contenant au moins une colonne e-mail. Le nom et la société sont obligatoires sur chaque ligne ; le téléphone et le pays sont facultatifs. Les doublons sont ignorés.",
