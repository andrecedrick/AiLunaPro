...
export const de: Dict = {
  ...
  invoices: {
    ...
    proposedBudget: 'Vorgeschlagenes Budget',
    ...
    nextNegotiation: 'Nächster Schritt: Kundenbudget prüfen und dann den Endbetrag festlegen.',
  ...
  myQuotes: {
    ...
    subtitle: 'Verfolgen Sie die von Ihnen gesendeten Angebote — Status, Budget und die letzte Aktivität.',
    loading: 'Wird geladen…',
    ...
    actAccepted: 'Kunde hat das Budget angenommen',
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "accepted": {
        ...
        "confirmTitle": "Vorgeschlagenes Budget bestätigen",
        "confirmBody": "Bestätigen Sie, um das vorgeschlagene Budget anzunehmen — wir bereiten Ihre Rechnung vor und informieren unser Team.",
        "confirmCta": "Vorgeschlagenes Budget annehmen",
