...
export const de: Dict = {
  ...
  bankSettings: {
    ...
    subtitle: 'Wird auf Rechnungen als Zahlungsoption angezeigt.',
    countryLabel: 'Ländercode',
    countryPlaceholder: 'z. B. DE',
    regionLabel: 'Bankregion',
    regionEu: 'Europa (IBAN)',
    regionUs: 'USA',
    regionGlobal: 'Asien / Global',
    fAccountName: 'Kontoname',
    fAccountNumber: 'Kontonummer',
    fRoutingNumber: 'Routing-Nummer',
    fBankName: 'Name der Bank',
    fAccountHolder: 'Kontoinhaber',
    save: 'Bankverbindung speichern',
    saved: 'Bankverbindung gespeichert',
    saveError: 'Speichern fehlgeschlagen. Bitte erneut versuchen.',
    validationError: 'Bitte diesen Wert prüfen.',
    ownerOnly: 'Nur Eigentümer und Administratoren können die Bankverbindung bearbeiten.',
  },
  invoices: {
    title: 'Rechnungen',
    ...
    sentNoEmail: 'Die E-Mail konnte nicht gesendet werden.',
    confirmationResent: 'Zahlungsbestätigung erneut gesendet',
    confirmationSentOn: 'Zahlungsbestätigung gesendet',
    invoiceSentOn: 'Rechnungs-E-Mail gesendet',
    resendNoRecipient: 'Diese Rechnung hat keine Kunden-E-Mail-Adresse.',
    resendConfirmationBtn: 'Zahlungsbestätigung erneut senden',
    downloadPdf: 'Rechnung herunterladen (PDF)',
    ...
    queueEmpty: 'Derzeit warten keine Angebote auf eine Preisfestlegung.',
    queueSubtitle: 'Ein Kunde hat geantwortet — legen Sie den Endbetrag fest, um die Rechnung zu erstellen.',
    stageAcceptedLabel: 'Angenommen',
    stageNegotiationLabel: 'Verhandlung',
    nextAccepted: 'Nächster Schritt: Endbetrag festlegen, um die Rechnung zu erstellen und zu senden.',
    clientMessageLabel: 'Kundennachricht',
  ...
  adminCenter: {
    nav: 'Admin Center',
    title: 'Admin Center',
    subtitle: 'Überwachen Sie Angebote, Rechnungen und Kundenaktivitäten Ihrer Organisation an einem Ort.',
    restricted: 'Das Admin Center ist Super-Administratoren vorbehalten.',
    activityHeading: 'Letzte Aktivität',
    activityEmpty: 'Noch keine Aktivität.',
    evtSent: 'Angebot versendet',
    evtAccepted: 'Angebot vom Kunden angenommen',
    ...
    allQuotesHeading: 'Alle Angebote — vollständiger Lebenszyklus',
    allQuotesEmpty: 'Noch keine Angebote gesendet.',
    tlCreated: 'Erstellt',
    tlSent: 'Gesendet',
    tlAccepted: 'Angenommen',
    tlChanges: 'Änderungen angefragt',
    tlInvoiced: 'In Rechnung gestellt',
    blocked: 'Gesperrt',
    ...
    orgQuotesHeading: 'Alle Angebote dieser Organisation',
    platformHeading: 'Plattform — alle Angebote (alle Organisationen)',
    platformEmpty: 'Noch keine Angebote in einer Organisation.',
    priceLabel: 'Preis',
    uidLabel: 'Benutzer-ID',
    orgLabel: 'Organisation',
    sourceLabel: 'Quelle',
    currencyLabel: 'Währung',
    stripeIdLabel: 'Stripe-ID',
    quoteIdLabel: 'Angebots-ID',
    paidLabel: 'Bezahlt',
    paymentPaid: 'Bezahlt',
    paymentPending: 'Zahlung ausstehend',
    paymentNone: 'Keine Rechnung',
  ...
  myQuotes: {
    ...
    subtitle: 'Verfolgen Sie die von Ihnen gesendeten Angebote — Status, Preis und die letzte Aktivität.',
    loading: 'Wird geladen…',
    error: 'Ihre Angebote konnten nicht geladen werden. Bitte erneut versuchen.',
    empty: 'Sie haben noch keine Angebote gesendet.',
    createCta: 'Angebot erstellen',
    quoteLabel: 'Angebot',
    proposedBudget: 'Angebotspreis',
    statusSent: 'Gesendet',
    statusReviewing: 'In Prüfung',
    statusNegotiation: 'Verhandlung',
    statusValidated: 'Bestätigt',
    statusInvoiced: 'In Rechnung gestellt',
    statusBlocked: 'Gesperrt',
    statusSuspended: 'Ausgesetzt',
    changesRequested: 'Kunde hat Änderungen angefragt',
    negotiationNextStep: 'Legen Sie den endgültigen Betrag im Admin Center fest, um zu antworten.',
    waitingResponse: 'Wartet auf die Antwort des Kunden',
    lastActivity: 'Letzte Aktivität',
    actCreated: 'Angebot erstellt',
    actSent: 'Angebot an Kunden gesendet',
    actAccepted: 'Kunde hat das Angebot angenommen',
    actChangesRequested: 'Kunde hat Änderungen angefragt',
    actInvoiced: 'Rechnung erstellt',
  },
  shell: {
  ...
  auth: {
    ...
    "error": { "companyRequired": "Unternehmen ist erforderlich." },
    "field": {
  ...
  orgCreate: {
    ...
    "planDesc": {
      ...
      "starter": "15 Audits, 5 Plätze",
      "professional": "30 Audits, 20 Plätze",
  ...
  agentsPages: {
    ...
    "recommendPanel": {
      ...
      "limitTitle": "Sie haben Ihr Monatslimit erreicht.",
      "limitBody": "Sie haben diesen Monat alle Ihre Empfehlungen verbraucht.",
      "limitBodyCount": "Sie haben diesen Monat alle {used} von {limit} Empfehlungen verbraucht.",
      "upgradeCta": "Upgraden Sie Ihren Tarif, um fortzufahren",
      "usageProgress": "{used} / {limit} Empfehlungen diesen Monat verbraucht"
    },
    "card": {
      "external": "Extern",
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "result": {
        ...
        "costOfDelayAmount": "Jeder Monat des Wartens kostet Sie rund {amount} an verlorener Zeit und verlorenem Geld.",
        "decisionHeading": "Ihre Entscheidung auf einen Blick",
        "decisionSummaryStrong": "Sie investieren {invest}, um {yearly}/Jahr zurückzugewinnen — {y1}× Rendite im ersten Jahr.",
        "decisionSummaryLong": "Sie investieren {invest}, um {yearly}/Jahr zurückzugewinnen — amortisiert in ~{months} Monaten.",
        "decisionReturnLabel": "Rendite 1. Jahr",
        "decisionThreeYearLabel": "Rendite über 3 Jahre",
      ...
      "send": {
        ...
        "intro": "Geben Sie die E-Mail Ihres Kunden ein — wir senden ihm das Angebot mit dem Angebotspreis, bereit zur Online-Freigabe.",
        "emailLabel": "E-Mail des Kunden",
        "emailRequired": "Die E-Mail-Adresse des Kunden ist erforderlich, um das Angebot zu senden.",
        "budgetBelowMin": "Das Budget muss mindestens {min} betragen (der geschätzte Mindestbetrag).",
        "submit": "Angebot an Kunden senden",
        "hint": "Ihr Kunde erhält das Angebot und bestätigt es online.",
      ...
      "accepted": {
        "bankProceedCta": "Freigeben — Überweisungsdaten erhalten",
        "bankMessage": "Bei Projekten über 15.000 $ erfolgt die Zahlung sicher per Banküberweisung.",
        "title": "Ihre Antwort wurde gesendet",
        "s1": "Rechnung erstellt — sofort verfügbar",
        "s2": "Sichere Online-Zahlung oder Überweisung",
        "s3": "Zahlungsbestätigung per E-Mail",
        "s4": "Projektstart durch unser Team",
        "step1": "Ihre Rechnung wird sofort erstellt",
        "step2": "Zahlen Sie online per Karte oder per Überweisung",
        "step3": "Sie erhalten eine Zahlungsbestätigung per E-Mail",
        "step4": "Unser Team startet Ihr Projekt",
        ...
        "confirmTitle": "Geben Sie Ihr Angebot frei",
        "confirmBody": "Ein Klick erstellt Ihre Rechnung sofort — Sie erhalten sichere Zahlungsoptionen (Karte oder Überweisung) und unser Team beginnt mit der Vorbereitung Ihres Projekts.",
        "confirmCta": "Freigeben & Rechnung erhalten",
        "confirming": "Ihre Rechnung wird erstellt…",
        "confirmError": "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut oder antworten Sie auf Ihre Angebots-E-Mail.",
        "discussConfirmBody": "Bestätigen Sie, um Ihre Anpassungsanfrage an unser Team zu senden.",
        "discussCta": "Anfrage senden",
        "sentTitle": "Anfrage erhalten",
        "sentBody": "Wir haben Ihre Anfrage erhalten und melden uns bei Ihnen, um das Angebot anzupassen.",
      ...
      "flow": {
        ...
        "s1": "Angebot annehmen",
        "s2": "Ihre Rechnung wird sofort erstellt",
        "s3": "Zahlung per Karte oder Überweisung",
        "s4": "Das Projekt startet"
      },
      "decision": {
        "priceLabel": "Empfohlene Investition",
        "valueItem1": "Lieferung von A bis Z — Scoping, Entwicklung, Deployment und Übergabe inklusive",
        "valueItem2": "Ein dediziertes Expertenteam, mit Begleitung in jedem Schritt",
        "valueItem3": "Der Umfang wird gemeinsam validiert, bevor etwas berechnet wird",
        "priceNote": "Keine Zahlung heute — die Rechnung wird erst nach Ihrer Freigabe des Angebots erstellt. Sichere Zahlung per Karte oder Überweisung.",
        "impactHeading": "Was dieses Projekt für Ihr Unternehmen verändert",
        "impact1": "Jede Woche Stunden manueller Arbeit automatisiert — Ihr Team konzentriert sich auf Wertschöpfung",
        "impact2": "Weniger manuelle Fehler und eine audit-fähige Compliance",
        "impact3": "Wachstum ohne zusätzliches Personal",
        "suggestedLabel": "Vorgeschlagener Preis (System)",
        "finalLabel": "Gesendeter Endpreis (USD)",
        "reasonPlaceholder": "Grund der Anpassung (optional)",
        "resetPrice": "Zurücksetzen",
        "billedUsd": "Abrechnung in USD. Der Kunde sieht den Betrag in seine Währung umgerechnet.",
      ...
      "status": {
        ...
        "paidThanks": "Zahlung eingegangen — vielen Dank! Ihre Bestätigungs-E-Mail ist unterwegs und unser Team startet Ihr Projekt.",
        "payReady": "Ihre Rechnung ist bereit — jetzt sicher bezahlen.",
        "openPanel": "Rechnungsbereich öffnen",
        "stateReview": "Prüfung",
        "stateNegotiation": "Verhandlung",
        "stateWaiting": "Warten auf Administrator",
        "stateInvoice": "Rechnung",
        "budgetLabel": "Angebotsbetrag",
  ...
  auditTools: {
    nav: {
      worksheetLabel: "Zeit-→-Geld-Audit",
      worksheetHint: "Mit Ihren echten Daten, Aufgabe für Aufgabe",
      visibilityLabel: "KI- & Social-Sichtbarkeit",
      visibilityHint: "Präsenz in ChatGPT/Perplexity + Social-Audit",
    },
    worksheet: {
      title: "Zeit-→-Geld-Audit",
      subtitle: "Tragen Sie Ihre echten Daten ein (keine Schätzungen). Für jede Aufgabe berechnet das Tool das Urteil, die tatsächlichen Jahreskosten und die zurückgewinnbaren Stunden. Wählen Sie Ihre Währung und den Zeitraum Ihres Einkommens (Monat/Jahr/Woche) — das Tool passt sich an Ihr Land an.",
      profile: {
        sectionTitle: "① Ihr Profil",
        incomeMonth: "Netto-Monatseinkommen",
        incomeYear: "Netto-Jahreseinkommen",
        incomeWeek: "Netto-Wocheneinkommen",
        periodLabel: "Einkommenszeitraum",
        periodMonth: "pro Monat",
        periodYear: "pro Jahr",
        periodWeek: "pro Woche",
        currencyLabel: "Währung",
        hoursLabel: "Stunden / Woche",
        hourlyRate: "→ Stundensatz",
        perHour: "/ Std.",
        invalidHint: "Geben Sie ein Einkommen und Stunden > 0 ein, um den Stundensatz zu berechnen.",
        helperPrompt: "Sie kennen Ihre Stunden/Woche nicht?",
        helperHoursPerDay: "Stunden / Tag",
        helperDaysPerWeek: "Tage / Woche",
        helperCalc: "Meine Stunden berechnen",
      },
      tasks: {
        sectionTitle: "② Ihre Aufgaben",
        tip: "Tipp: Schreiben Sie den genauen Titel (Verb + Objekt), z. B. \"die Angebote prüfen\", nicht \"Verwaltung\".",
        colTask: "Aufgabe",
        colHours: "Std / Wo",
        colWho: "Wer kann es erledigen?",
        colRules: "Klare Regeln?",
        colEnergy: "Energie",
        colVerdict: "Urteil",
        colCost: "Kosten / Jahr",
        colRecovered: "Zurückgew. Std",
        taskPlaceholder: "Aufgabenname",
        addRow: "+ Aufgabe hinzufügen",
        addCommon: "+ Häufige Aufgabe hinzufügen…",
        addCommonHint: "Unsicher, was Sie hinzufügen sollen? Wählen Sie eine häufige Aufgabe.",
        splitInto: "In {n} Aufgaben aufteilen",
      },
      who: { self: "Nur ich", specialist: "Eine geschulte Fachkraft", anyone: "Jede geschulte Person" },
      rules: { yes: "Ja", no: "Nein" },
      energy: { energizing: "Energiespendend", neutral: "Neutral", draining: "Kräftezehrend" },
      verdict: { keep: "✅ BEHALTEN", automate: "🤖 AUTOMATISIEREN", delegate: "→ DELEGIEREN", rethink: "⚠️ ÜBERDENKEN" },
      summary: {
        recoveredHoursYear: "Zurückgewinnbare Stunden / Jahr",
        recoveredValueYear: "Zurückgewinnbarer Wert / Jahr",
        toAutomate: "Zu automatisieren",
        toDelegate: "Zu delegieren",
      },
      quickWins: {
        title: "③ Beginnen Sie hiermit (Quick Wins)",
        sub: "Zurückgewinnbare Aufgaben nach Wirkung (Kosten/Jahr) ÷ Aufwand sortiert. Fangen Sie oben an.",
        effortLow: "gering",
        effortMed: "mittel",
        effortLabel: "Aufwand",
        perYearSuffix: "/Jahr",
      ...
      cta: {
        headline: "Sie können {value} pro Jahr zurückgewinnen.",
        body: "{count} Aufgabe(n) zum Automatisieren oder Delegieren. Wir kalkulieren die Umsetzung in einem maßgeschneiderten Angebot.",
        button: "Meinen Automatisierungsplan erstellen →",
      },
      actions: {
        save: "💾 Speichern",
        loadExample: "Beispiel laden",
        reset: "Zurücksetzen",
        savedCloud: "Audit gespeichert ✓ (Cloud + lokal)",
        savedLocal: "Audit gespeichert ✓ (lokal auf diesem Gerät)",
        needProfile: "Füllen Sie das Profil und mindestens eine Aufgabe aus.",
        loadOk: "Audit geladen ✓",
        loadFail: "Konnte nicht geladen werden.",
        deleteFail: "Konnte nicht gelöscht werden.",
      },
      savedList: {
        title: "Meine gespeicherten Audits",
        perYear: "/Jahr zurückgew.",
        cloud: "Cloud",
        local: "lokal",
        load: "Laden",
        delete: "Löschen",
      },
      verdictRule: "Urteil: Nur ich + energiespendend → Behalten · sonst Überdenken. Andernfalls Jede Person + klare Regeln → Automatisieren · sonst Delegieren.",
      quoteSeedMain: "{count} Aufgabe(n), die über das Zeit-→-Geld-Audit identifiziert wurden, automatisieren / delegieren (≈ {value}/Jahr zurückgewinnbar)",
      quoteSeedTasks: ". Aufgaben: {tasks}.",
      quoteSeedEnd: ".",
    },
    visibility: {
      title: "Selbsteinschätzung KI- & Social-Sichtbarkeit",
      subtitle: "Bewerten Sie Ihre Präsenz in KI-Antworten (GEO) und in den sozialen Medien. Antworten Sie mit Nein / Teilweise / Ja; Punktzahl und Empfehlungen werden live aktualisiert.",
      disclaimer: "Deklarativer Reifegrad-Indikator: Die Punktzahl spiegelt Ihre eigenen Antworten wider, sie ist keine Messung der KI-Engines. Für ein gemessenes Audit fordern Sie einen Aktionsplan an.",
      choices: { non: "Nein", partiel: "Teilweise", oui: "Ja" },
      dims: {
        geoTitle: "KI-Sichtbarkeit (GEO / KI-Suche)",
        geoSub: "Präsenz und Genauigkeit in ChatGPT, Perplexity, Gemini, Google AI.",
        socialTitle: "Soziale Medien & Content",
        socialSub: "Autorität, aussagekräftige Kennzahlen, Konsistenz, Kontrolle von KI-Content.",
      },
      scoreGlobal: "Gesamtpunktzahl (deklarativ)",
      note: "Note",
      answeredOf: "{a}/{t} beantwortet",
      empty: "Beantworten Sie die Fragen unten — Ihr Reifegrad und Ihre Empfehlungen erscheinen hier.",
      recosTitle: "Prioritäre Empfehlungen",
      geoTag: "GEO",
      socialTag: "Social",
      cta: {
        headline: "Machen Sie aus Note {grade} einen Aktionsplan.",
        body: "Wir kalkulieren die Umsetzung Ihrer {count} Prioritäten in einem Angebot.",
        button: "Aktionsplan / Angebot erhalten →",
      },
      reset: "Zurücksetzen",
      questions: {
        byId: {
          geo_offer:      { label: "Beschreiben KI-Tools (ChatGPT, Perplexity, Gemini) Ihr Angebot und Ihre Vorteile (USP) korrekt?", reco: "Veröffentlichen Sie klare \"Source-of-Truth\"-Seiten (Angebot, USP, Preise), damit KI-Engines die richtigen Fakten zitieren." },
          geo_appear:     { label: "Erscheint Ihre Marke in KI-Antworten zu Ihren wichtigsten Suchanfragen?", reco: "Testen Sie Ihre 10 wichtigsten Suchanfragen in ChatGPT/Perplexity; streben Sie Präsenz an und ergänzen Sie die fehlenden Seiten." },
          geo_cited:      { label: "Wird Ihre Website von KI-Engines als Quelle zitiert?", reco: "Finden Sie die zitierten Drittquellen (Reddit, Quora, Medien), in denen Sie fehlen → eine priorisierte Digital-PR-Liste." },
          geo_competitor: { label: "Wissen Sie, wie die KI Sie mit Ihren Wettbewerbern vergleicht (wen sie hervorhebt)?", reco: "Auditieren Sie die Wettbewerbspositionierung in KI-Antworten und identifizieren Sie das Argument, mit dem der Wettbewerber gewinnt." },
          geo_sentiment:  { label: "Ist das KI-Sentiment zu Ihrer Marke positiv und korrekt?", reco: "Korrigieren Sie negative/falsche Fakten an der Quelle (Ihre Website), damit KI-Engines ihre Wahrnehmung aktualisieren." },
          geo_structured: { label: "Haben Sie strukturierten Content (FAQ, Schema, Pillar-Pages), der dafür optimiert ist, von KI erfasst zu werden?", reco: "Ergänzen Sie FAQ, strukturierte Daten (schema.org) und Pillar-Pages, um als Source of Truth erfasst zu werden." },
          soc_story:      { label: "Baut Ihr Social-Content Autorität auf (Storytelling) statt Demo-Spam?", reco: "Wechseln Sie von Feature-Spam zu Storytelling (Rückschläge/Erfolge), um Autorität aufzubauen." },
          soc_meetings:   { label: "Messen Sie die generierten qualifizierten Termine (über Likes/Impressionen hinaus)?", reco: "Verfolgen Sie die Kennzahl \"qualifizierte Termine\": Darauf kommt es an, nicht auf Likes." },
          soc_cadence:    { label: "Veröffentlichen Sie in einem regelmäßigen, nachhaltigen Rhythmus?", reco: "Richten Sie einen regelmäßigen Redaktionskalender ein (ein nachhaltiger Rhythmus schlägt unregelmäßige Ausschläge)." },
          soc_unique:     { label: "Spiegelt Ihr Content einzigartige, schwer kopierbare Expertise wider (\"productize yourself\")?", reco: "Heben Sie Ihren einzigartigen Blickwinkel/Ihre Expertise hervor, um dem generischen Wettbewerb zu entkommen." },
          soc_repurpose:  { label: "Verwerten Sie Ihren Content in mehreren Formaten weiter?", reco: "Verwerten Sie jeden Inhalt in mehreren Formaten weiter (Post, Video, Carousel), um die Reichweite zu vervielfachen." },
          soc_oversight:  { label: "Wird KI-generierter Content überwacht (gegen \"Shadow Social\" / Halluzinationen)?", reco: "Ergänzen Sie eine menschliche Prüfung von KI-Content, um Halluzinationen und Authentizitätsverlust zu vermeiden." },
        },
      },
    },
    taskCatalog: {
      ...
      tasks: {
        emails_reply: "E-Mails beantworten",
        appointments: "Termine vereinbaren",
        schedule: "Kalender- / Terminverwaltung",
        filing: "Dokumentenablage",
        cold_calls: "Kaltakquise-Anrufe",
        followups: "Kunden-Nachfassaktionen",
        quotes_write: "Angebote erstellen",
        crm_entry: "CRM-Dateneingabe",
        inbound_calls: "Eingehende Anrufe (Support)",
        support_l1: "First-Level-Kundensupport",
        reviews_faq: "Bewertungsantworten / FAQ",
        content_social: "Social-Content erstellen",
        social_planning: "Social-Media-Planung",
        market_research: "Marktforschung / Monitoring",
        accounting: "Buchhaltung / Rechnungsstellung",
        weekly_report: "Wöchentliches Reporting",
        cv_screening: "Lebenslauf-Screening / Vorauswahl",
        expenses: "Spesenabrechnungen",
        data_entry: "Dateneingabe / Erfassung",
        inventory: "Lager- / Bestandsverwaltung",
        translation: "Content-Übersetzung",
        blog_writing: "Artikel / Blog schreiben",
        high_prospecting: "Hochwertige Akquise / Meetings",
        vision: "Strategie & Vision",
        onboarding: "Kunden-Onboarding",
        email_support: "Kundensupport-E-Mails",
        email_sales: "Vertriebs-Nachfass-E-Mails",
        meetings_internal: "Interne Meetings",
        meetings_client: "Kundenmeetings",
        content_create: "Content-Erstellung",
        content_publish: "Planung / Veröffentlichung",
        invoice_issue: "Rechnungen ausstellen",
        quotes_custom: "Individuelle Angebote",
        interviews: "Bewerbungsgespräche",
      },
      hints: {
        calls: "Unklar: EINGEHENDE Anrufe (Support) oder AUSGEHENDE (Akquise)? Das Urteil unterscheidet sich — trenne sie.",
        email: "Sei konkret: Kundensupport, Vertriebs-Nachfassaktionen oder interner Austausch? Jeder Fall hat ein eigenes Urteil.",
        meeting: "Intern oder mit Kunden? Wiederkehrend oder einmalig? Wichtige Kundenmeetings lohnt es sich zu behalten.",
        content: "Trenne ERSTELLUNG (Urteilsvermögen, behalten) und VERÖFFENTLICHUNG/Planung (regelbasiert, automatisierbar).",
        invoice: "Standard-Ausstellung (klare Regeln → automatisieren) vs. Verhandlung/individuell (Urteilsvermögen → behalten/delegieren).",
        report: "Wenn die Daten bereits strukturiert sind, ist das Reporting oft automatisierbar.",
        recruit: "Lebenslauf-Screening (klare Kriterien → automatisierbar) vs. finales Gespräch (menschliches Urteil → behalten).",
        data: "Strukturierte Eingabe? Dateneingabe/-kopieren ist fast immer automatisierbar.",
        writing: "Erster Entwurf (KI-Copilot, schnell) vs. finale Prüfung/Lektorat (menschliches Urteil).",
        translate: "Repetitives Volumen → automatisierbar; Marketing-/Rechtsnuancen → menschliche Prüfung.",
        logistics: "Routenoptimierung / Bestandsverfolgung → automatisierbar; Beziehungen zu Spediteuren → menschlich.",
      },
      seed: {
        emails_slack: "E-Mails / Slack beantworten",
        accounting_billing: "Buchhaltung, Rechnungsstellung",
        prospecting_clients: "Akquise / Kundenmeetings",
        crm_data: "CRM-Dateneingabe",
        social_mgmt: "Social-Media-Management",
        manual_reporting: "Manuelles wöchentliches Reporting",
        planning_agenda: "Kalender- / Terminverwaltung",
        client_quote: "Kundenangebot",
      },
    },
  },
  contacts: {
    nav: "Kontakte",
    title: "Kontakte",
    subtitleOrg: "Verwalte die Kontakte und Leads deiner Organisation.",
    subtitleAll: "Alle Kontakte aus sämtlichen Organisationen (schreibgeschützt).",
    modeOrg: "Meine Organisation",
    modeAll: "Alle Organisationen",
    readOnlyNotice: "Schreibgeschützte organisationsübergreifende Ansicht (Plattform-Betreiber). Wechsle zu „Meine Organisation“, um deine eigenen Kontakte zu verwalten.",
    noAccess: "Du hast keinen Zugriff auf Kontakte.",
    create: "+ Neuer Kontakt",
    searchPlaceholder: "Name, E-Mail, Unternehmen suchen…",
    allTags: "Alle Tags",
    ...
    colActions: "Aktionen",
    loading: "Wird geladen…",
    empty: "Keine passenden Kontakte.",
    edit: "Bearbeiten",
    block: "Sperren",
    unblock: "Entsperren",
    delete: "Löschen",
    ...
    lastReassignedBy: "Zuletzt neu zugewiesen von",
    lastReassignedAt: "Zuletzt neu zugewiesen am",
    ...
    importErrors: {
      ...
      DUPLICATE_IN_FILE: "Duplikat in der Datei",
      DUPLICATE_EXISTING: "Bereits im CRM",
      MISSING_NAME: "Name fehlt",
      MISSING_COMPANY: "Unternehmen fehlt",
      INVALID_PHONE: "Ungültige Telefonnummer",
      INVALID_COUNTRY: "Ungültiges Land",
      WRITE_FAILED: "Speichern fehlgeschlagen",
    },
    sources: {
      manual: "Manuell",
      quote: "Angebot",
    ...
    errors: {
      DUPLICATE_EMAIL: "Ein Kontakt mit dieser E-Mail-Adresse existiert in dieser Organisation bereits.",
      FORBIDDEN: "Sie können nur Kontakte verwalten, die Ihnen zugewiesen sind.",
      FORBIDDEN_STATUS: "Nur ein Inhaber oder Admin kann einen Kontakt sperren oder dessen Status ändern.",

      FORBIDDEN_ASSIGN: "Nur ein Super-Administrator kann einen Kontakt einem anderen Benutzer zuweisen.",

      NOT_A_MEMBER: "Dieser Benutzer ist kein aktives Mitglied dieses Workspace.",
      ...
      NOT_FOUND: "Dieser Kontakt existiert nicht mehr.",
      LOAD_FAILED: "Kontakte konnten nicht geladen werden.",
   ...
   */
  enrichment: {
    title: 'In öffentlichen Quellen beobachtete KI-Systeme',
    subtitle: 'Öffentliche Belege im Abgleich mit Ihrem KI-Register für',
    loading: 'Beleg-Snapshot wird geladen…',
    loadError: 'Die Belege für diesen Bericht konnten nicht geladen werden.',
    notFound: 'Diesem Bericht ist kein Beleg-Snapshot zugeordnet.',
    integrityFailed: 'Dieser Beleg-Snapshot stimmt nicht mehr mit seinem gespeicherten Fingerabdruck überein und kann nicht angezeigt werden.',
    disclaimer: 'Die Belege wurden zum angegebenen Zeitpunkt aus öffentlich zugänglichen Quellen erhoben. Die Feststellungen beschreiben, was beobachtet und was deklariert wurde; sie sind weder eine rechtliche Bewertung noch eine Zertifizierung.',
    snapshotId: 'Snapshot',
    ...
    engine: 'Engine',
    rulesets: 'Regelsätze',
    coverageTitle: 'Was analysiert wurde',
    coverageNone: 'Für diesen Snapshot wurde keine Quelle abgefragt.',
    sourcesRead: 'Erfolgreich gelesene Quellen',
    coverageIncomplete: 'Die Abdeckung war unvollständig. Die oben aufgeführten Quellen wurden nicht gelesen; dieser Abschnitt ist daher keine vollständige Übersicht Ihrer KI-Nutzung.',
    dropped: '{n} weitere Beobachtung(en) wurden verworfen, da der Snapshot sein Belegvolumen erreicht hat.',
    covRead: 'Gelesen',
    covPartial: 'Teilweise gelesen',
    covRateLimited: 'Rate-Limit erreicht',
    covUnavailable: 'Quelle nicht verfügbar',
    covBlocked: 'Blockiert',
    covNotAnalyzed: 'Nicht analysiert',
    observedTitle: 'Beobachtete Systeme',
    observedNone: 'In den gelesenen Quellen wurde kein KI-System identifiziert.',
    isDeclared: 'deklariert',
    notDeclared: 'nicht deklariert',
    declaredTitle: 'Deklarierte Systeme (KI-Register)',
    declaredNone: 'Ihr KI-Register enthält keinen aktiven Eintrag.',
    corroborated: 'bestätigt',
    noPublicEvidence: 'keine öffentlichen Belege',
    cannotCompare: 'nicht vergleichbar',
    findingsTitle: 'Feststellungen',
    findingsNone: 'Zwischen den in öffentlichen Quellen beobachteten Systemen und den in Ihrem KI-Register erfassten Systemen wurde keine Lücke gefunden.',
    impactTotal: '{n} Feststellung(en). Auf Ihre Bewertung angewandter Compliance-Effekt: {points} Punkt(e).',
    capped: 'begrenzt',
    ...
    ruleId: 'Regel',
    subject: 'Gegenstand',
    complianceImpact: 'Compliance-Effekt',
    impactNone: 'keiner (nur gemeldet)',
    evidenceTitle: 'Belege',
    evidenceAbsence: 'Diese Feststellung beruht auf dem Fehlen einer Beobachtung und zitiert daher keinen erfassten Beleg.',
    evidenceId: 'Beleg-ID',
    hash: 'Hash',
    comparisonTitle: 'Beobachtet vs. deklariert',
    observedLabel: 'Beobachtet',
    declaredLabel: 'Deklariert',
    gapLabel: 'Lücke',
    notObserved: 'nicht in öffentlichen Quellen beobachtet',
    noRegistryEntry: 'kein passender Eintrag im KI-Register',
    gapUndeclared: 'Beobachtet, aber nicht deklariert',
    gapUnverified: 'Deklariert, aber nicht beobachtet',
    gapIncomplete: 'Registereintrag nicht vergleichbar',
