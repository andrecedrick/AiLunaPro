...
export const zh: Dict = {
  ...
  invoices: {
    ...
    sent: '发票已成功发送',
    sentNoEmail: '邮件发送失败。',
    confirmationResent: '付款确认已重新发送',
    confirmationSentOn: '付款确认已发送',
    invoiceSentOn: '发票邮件已发送',
    resendNoRecipient: '此发票没有客户邮箱地址。',
    resendConfirmationBtn: '重新发送付款确认',
  ...
  adminCenter: {
    ...
    orgQuotesHeading: '本组织的所有报价',
    platformHeading: '平台 — 所有报价（所有组织）',
    platformEmpty: '目前所有组织都没有报价。',
    priceLabel: '价格',
    uidLabel: '用户 ID',
    orgLabel: '组织',
    sourceLabel: '来源',
  ...
  publicTools: {
    ...
    "quote": {
      ...
      "result": {
        ...
        "decisionHeading": "一目了然的决策",
        "decisionSummaryStrong": "投入 {invest} 即可每年收回 {yearly}——首年回报达 {y1}×。",
        "decisionSummaryLong": "投入 {invest} 即可每年收回 {yearly}——约 {months} 个月即可回本。",
        "decisionReturnLabel": "首年回报",
        "decisionThreeYearLabel": "三年回报",
      ...
      "send": {
        "heading": "将提案发送给您的客户",
        "intro": "输入客户的电子邮箱——我们会将包含报价金额的提案发送给客户，供其在线确认。",
        "emailLabel": "客户邮箱",
        "emailRequired": "发送提案需要填写客户邮箱。",
        "budgetBelowMin": "预算必须至少为 {min}（预估最低值）。",
        "submit": "将提案发送给客户",
        "hint": "客户收到提案后可在线确认报价。",
        "sentTo": "提案已发送至 {email}",
      ...
      "accepted": {
        ...
        "confirmTitle": "批准您的报价",
        "confirmBody": "一键即可立即生成发票——您将获得安全付款方式（银行卡或转账），我们的团队随即开始筹备您的项目。",
        "confirmCta": "批准并获取发票",
        "confirming": "正在生成您的发票…",
      ...
      "decision": {
        "priceLabel": "建议投资额",
        "valueItem1": "端到端交付——范围界定、开发、部署与交接全包",
        "valueItem2": "专属专家团队，每一步都有支持",
        "valueItem3": "范围与您共同确认后才会开票",
        "priceNote": "今天无需付款——发票仅在您批准提案后开具。支持银行卡或转账安全付款。",
        "impactHeading": "这个项目将为您的业务带来什么改变",
        "impact1": "每周自动化数小时的手动工作——团队专注于高价值任务",
        "impact2": "减少人工错误，合规状态随时可审计",
        "impact3": "无需扩编即可扩展业务规模",
      ...
      "status": {
        ...
        "payNow": "立即付款",
        "paidThanks": "已收到付款——谢谢！确认邮件正在发送，我们的团队即将启动您的项目。",
  ...
  contacts: {
    nav: "联系人",
    title: "联系人",
    subtitleOrg: "管理你所在组织的联系人和潜在客户。",
    subtitleAll: "所有组织的全部联系人（只读）。",
    modeOrg: "我的组织",
    modeAll: "所有组织",
    readOnlyNotice: "跨组织只读视图（平台运营方）。切换到“我的组织”以管理你自己的联系人。",
    noAccess: "你没有访问联系人的权限。",
    create: "+ 新建联系人",
    ...
    assignedBy: "分配人",
    assignedAt: "分配时间",
    lastReassignedBy: "最近转交人",
    lastReassignedAt: "最近转交时间",
    assignTo: "分配给",
    assign: "分配",
    transfer: "转交",
    importCsv: "导入",
    ...
    importErrors: {
      ...
      DUPLICATE_EXISTING: "已在 CRM 中",
      MISSING_NAME: "缺少姓名",
      MISSING_COMPANY: "缺少公司",
      INVALID_PHONE: "电话无效",
      INVALID_COUNTRY: "国家/地区无效",
      WRITE_FAILED: "无法保存",
    },
    sources: {
      manual: "手动",
    ...
    errors: {
      DUPLICATE_EMAIL: "此组织中已存在使用该邮箱的联系人。",
      FORBIDDEN: "您只能管理分配给您的联系人。",
      FORBIDDEN_STATUS: "只有所有者或管理员才能封禁或更改联系人状态。",

      FORBIDDEN_ASSIGN: "只有超级管理员才能将联系人分配给其他用户。",

      NOT_A_MEMBER: "该用户不是此工作区的活跃成员。",
   ...
   */
  enrichment: {
    title: '公开来源中发现的 AI 系统',
    subtitle: '公开证据与你的 AI 登记册比对，对象为',
    loading: '正在加载证据快照…',
    loadError: '无法加载此报告的证据。',
    notFound: '此报告未关联任何证据快照。',
    integrityFailed: '此证据快照已与记录的指纹不一致，无法显示。',
    disclaimer: '证据于所示时间从公开可访问的来源采集。结论描述观察到的内容与申报的内容，既非法律结论，也非认证。',
    snapshotId: '快照',
    capturedAt: '采集时间',
    surface: '审计类型',
    fingerprint: '指纹',
    ...
    rulesets: '规则集',
    coverageTitle: '分析范围',
    coverageNone: '此快照未尝试任何来源。',
    sourcesRead: '成功读取的来源',
    coverageIncomplete: '覆盖不完整。上列来源未被读取，因此本节并非你 AI 使用情况的完整视图。',
    dropped: '因快照达到证据上限，另有 {n} 条观察被丢弃。',
    covRead: '已读取',
    covPartial: '部分读取',
    covRateLimited: '触发限流',
    covUnavailable: '来源不可用',
    covBlocked: '被阻止',
    covNotAnalyzed: '未分析',
    observedTitle: '观察到的系统',
    observedNone: '在已读取的来源中未识别出任何 AI 系统。',
    isDeclared: '已申报',
    notDeclared: '未申报',
    declaredTitle: '已申报系统（AI 登记册）',
    declaredNone: '你的 AI 登记册中没有任何有效条目。',
    corroborated: '已印证',
    noPublicEvidence: '无公开证据',
    cannotCompare: '无法比对',
    findingsTitle: '结论',
    findingsNone: '公开来源中观察到的系统与你 AI 登记册中的记录之间未发现差距。',
    impactTotal: '共 {n} 条结论。应用于评分的合规影响：{points} 分。',
    capped: '已封顶',
    riskCritical: '严重',
    riskHigh: '高',
    riskMedium: '中',
    ...
    impactNone: '无（仅报告）',
    evidenceTitle: '证据',
    evidenceAbsence: '此结论基于观察的缺失，因此不引用任何已采集证据。',
    evidenceId: '证据 ID',
    hash: '哈希',
    comparisonTitle: '观察与申报对比',
    observedLabel: '观察到',
    declaredLabel: '已申报',
    gapLabel: '差距',
    notObserved: '未在公开来源中观察到',
    noRegistryEntry: 'AI 登记册中无匹配条目',
    gapUndeclared: '已观察但未申报',
    gapUnverified: '已申报但未观察到',
    gapIncomplete: '登记册条目无法比对',
