 ...
 * Used by the ROI Calculator so the client shows the same recommended agents.
 */
 ...
 * Used by the Audit Temps→Argent worksheet engine (src/lib/worksheet/auditWorksheet.ts).
 * MIRROR of worker/src/data/roi-config.ts.
 */
